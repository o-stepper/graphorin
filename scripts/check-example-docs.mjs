...
const PNPM_BUILTINS = new Set([
  'add', 'remove', 'install', 'i', 'update', 'up', 'exec', 'dlx', 'why', 'list',
  'ls', 'outdated', 'publish', 'pack', 'rebuild', 'prune', 'link', 'unlink',
  'audit', 'licenses', 'import', 'fetch', 'deploy', 'patch', 'store', 'config',
  'create', 'init', 'setup', 'env', 'root', 'bin', 'dedupe', 'run',
]);
