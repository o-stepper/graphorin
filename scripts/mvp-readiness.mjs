 ...
 * mvp-readiness.mjs
 *
 * Single entry point that runs the v0.1.0 release-readiness gates
 ...
 *                          version 0.1.0, license MIT, author Oleksiy Stepurenko,
...
async function main() {
  ...
  if (json) {
    ...
    console.log('==============================');
    if (overallOk) {
      console.log('mvp-readiness: PASS — every gate is green; v0.1.0 is release-shaped.');
    } else {
      console.error(
