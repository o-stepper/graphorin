...
| <a id="property-notes"></a> `notes?` | `readonly` | `string` | Free-form notes for tooling / docs. | pricing/src/types.ts:33 |
...
| <a id="property-reasoningusdpertoken"></a> `reasoningUsdPerToken?` | `readonly` | `number` | Optional reasoning-token price (OpenAI o1 / Gemini 2 thinking). | pricing/src/types.ts:29 |
| <a id="property-region"></a> `region?` | `readonly` | `string` | Optional region label (e.g. `'us-east-1'`). | pricing/src/types.ts:31 |
