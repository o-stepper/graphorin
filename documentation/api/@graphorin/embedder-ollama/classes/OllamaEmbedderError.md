...
Defined in: [packages/embedder-ollama/src/index.ts:87](https://github.com/o-stepper/graphorin/blob/main/packages/embedder-ollama/src/index.ts#L87)
...
Defined in: [packages/embedder-ollama/src/index.ts:89](https://github.com/o-stepper/graphorin/blob/main/packages/embedder-ollama/src/index.ts#L89)
...
| <a id="property-name"></a> `name` | `readonly` | `"OllamaEmbedderError"` | `'OllamaEmbedderError'` | - | `Error.name` | - | [packages/embedder-ollama/src/index.ts:88](https://github.com/o-stepper/graphorin/blob/main/packages/embedder-ollama/src/index.ts#L88) |
...
| <a id="property-statuscode"></a> `statusCode?` | `readonly` | `number` | `undefined` | - | - | - | [packages/embedder-ollama/src/index.ts:91](https://github.com/o-stepper/graphorin/blob/main/packages/embedder-ollama/src/index.ts#L91) |
