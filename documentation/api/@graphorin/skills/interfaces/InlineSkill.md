...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-basepath"></a> `basePath?` | `readonly` | `string` | - | packages/skills/src/types/index.ts:106 |
| <a id="property-resources"></a> `resources?` | `readonly` | readonly \{ `content`: `string`; `path`: `string`; \}[] | - | packages/skills/src/types/index.ts:107 |
| <a id="property-skillmd"></a> `skillMd` | `readonly` | `string` | - | packages/skills/src/types/index.ts:105 |
