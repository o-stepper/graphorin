...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-activatedat"></a> `activatedAt` | `readonly` | `number` | - | packages/skills/src/types/index.ts:306 |
| <a id="property-activationkind"></a> `activationKind` | `readonly` | `"auto"` \| `"slash-command"` \| `"explicit"` | - | packages/skills/src/types/index.ts:305 |
| <a id="property-body"></a> `body` | `readonly` | `string` | - | packages/skills/src/types/index.ts:294 |
| <a id="property-resources"></a> `resources` | `readonly` | readonly [`SkillResource`](/api/@graphorin/skills/interfaces/SkillResource.md)[] | - | packages/skills/src/types/index.ts:295 |
| <a id="property-skill"></a> `skill` | `readonly` | [`Skill`](/api/@graphorin/skills/interfaces/Skill.md) | - | packages/skills/src/types/index.ts:293 |
