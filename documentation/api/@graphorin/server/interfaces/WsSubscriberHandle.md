...
Defined in: [packages/server/src/ws/dispatcher.ts:75](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L75)
...
| ------ | ------ | ------ | ------ |
| <a id="property-grantedscopes"></a> `grantedScopes` | `readonly` | readonly [`ParsedScope`](/api/@graphorin/security/type-aliases/ParsedScope.md)[] | [packages/server/src/ws/dispatcher.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L78) |
| <a id="property-id"></a> `id` | `readonly` | `string` | [packages/server/src/ws/dispatcher.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L76) |
| <a id="property-tokenid"></a> `tokenId` | `readonly` | `string` | [packages/server/src/ws/dispatcher.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L77) |
...
Defined in: [packages/server/src/ws/dispatcher.ts:92](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L92)
...
Defined in: [packages/server/src/ws/dispatcher.ts:82](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L82)
...
Defined in: [packages/server/src/ws/dispatcher.ts:80](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/ws/dispatcher.ts#L80)
