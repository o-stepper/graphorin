...
Defined in: packages/server/src/health/checks.ts:47
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-lastcheckpointat"></a> `lastCheckpointAt?` | `readonly` | `string` | - | packages/server/src/health/checks.ts:50 |
...
| <a id="property-walsizebytes"></a> `walSizeBytes` | `readonly` | `number` | - | packages/server/src/health/checks.ts:48 |
| <a id="property-warnthresholdbytes"></a> `warnThresholdBytes` | `readonly` | `number` | - | packages/server/src/health/checks.ts:49 |
