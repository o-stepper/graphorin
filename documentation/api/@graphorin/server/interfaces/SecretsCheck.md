...
Defined in: [packages/server/src/health/checks.ts:60](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L60)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-activestore"></a> `activeStore` | `readonly` | `string` | - | [packages/server/src/health/checks.ts:61](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L61) |
