...
| <a id="property-subjectkind"></a> `subjectKind` | `readonly` | \| `"session-events"` \| `"session-run-events"` \| `"agent-run-events"` \| `"workflow-events"` \| `"workflow-run-events"` \| `"memory-conflicts"` \| `"audit-events"` | packages/server/src/ws/dispatcher.ts:104 |
