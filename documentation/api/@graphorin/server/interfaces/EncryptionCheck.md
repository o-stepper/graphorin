...
Defined in: [packages/server/src/health/checks.ts:65](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L65)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-enabled"></a> `enabled` | `readonly` | `boolean` | - | [packages/server/src/health/checks.ts:66](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L66) |
...
| <a id="property-peerdepinstalled"></a> `peerDepInstalled` | `readonly` | `boolean` | - | [packages/server/src/health/checks.ts:67](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L67) |
