...
Defined in: packages/server/src/health/checks.ts:66
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-enabled"></a> `enabled` | `readonly` | `boolean` | - | packages/server/src/health/checks.ts:67 |
...
| <a id="property-peerdepinstalled"></a> `peerDepInstalled` | `readonly` | `boolean` | - | packages/server/src/health/checks.ts:68 |
