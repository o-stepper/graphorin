...
Defined in: packages/server/src/health/checks.ts:93
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-eventsbuffered"></a> `eventsBuffered` | `readonly` | `number` | - | packages/server/src/health/checks.ts:94 |
...
| <a id="property-subscribers"></a> `subscribers?` | `readonly` | `number` | - | packages/server/src/health/checks.ts:95 |
| <a id="property-subscriptions"></a> `subscriptions?` | `readonly` | `number` | - | packages/server/src/health/checks.ts:96 |
