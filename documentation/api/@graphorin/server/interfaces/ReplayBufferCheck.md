...
Defined in: [packages/server/src/health/checks.ts:93](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L93)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-eventsbuffered"></a> `eventsBuffered` | `readonly` | `number` | - | [packages/server/src/health/checks.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L94) |
...
| <a id="property-subscribers"></a> `subscribers?` | `readonly` | `number` | - | [packages/server/src/health/checks.ts:95](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L95) |
| <a id="property-subscriptions"></a> `subscriptions?` | `readonly` | `number` | - | [packages/server/src/health/checks.ts:96](https://github.com/o-stepper/graphorin/blob/main/packages/server/src/health/checks.ts#L96) |
