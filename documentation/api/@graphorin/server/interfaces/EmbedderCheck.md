...
Defined in: packages/server/src/health/checks.ts:53
...
| <a id="property-model"></a> `model?` | `readonly` | `string` | - | packages/server/src/health/checks.ts:55 |
| <a id="property-modelloaded"></a> `modelLoaded` | `readonly` | `boolean` | - | packages/server/src/health/checks.ts:54 |
