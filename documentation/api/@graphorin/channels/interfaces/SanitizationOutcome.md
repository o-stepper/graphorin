...
| <a id="property-bytesstripped"></a> `bytesStripped` | `readonly` | `number` | Bytes removed by the strip pass. | [packages/tools/dist/inbound/sanitize.d.ts](https://github.com/o-stepper/graphorin/blob/main/packages/tools/dist/inbound/sanitize.d.ts) |
