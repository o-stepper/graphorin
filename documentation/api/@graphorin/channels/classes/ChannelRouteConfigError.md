...
Defined in: [packages/channels/src/router.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/router.ts#L76)
...
Defined in: [packages/channels/src/router.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/router.ts#L78)
...
| <a id="property-name"></a> `name` | `readonly` | `"ChannelRouteConfigError"` | `'ChannelRouteConfigError'` | - | `Error.name` | - | [packages/channels/src/router.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/router.ts#L77) |
