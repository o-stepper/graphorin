...
Defined in: [packages/channels/src/gateway.ts:147](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/gateway.ts#L147)
...
Defined in: [packages/channels/src/gateway.ts:149](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/gateway.ts#L149)
...
| <a id="property-name"></a> `name` | `readonly` | `"ChannelGatewayConfigError"` | `'ChannelGatewayConfigError'` | - | `Error.name` | - | [packages/channels/src/gateway.ts:148](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/gateway.ts#L148) |
