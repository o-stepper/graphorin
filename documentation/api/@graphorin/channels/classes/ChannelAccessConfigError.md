...
Defined in: [packages/channels/src/access.ts:93](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/access.ts#L93)
...
Defined in: [packages/channels/src/access.ts:95](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/access.ts#L95)
...
| <a id="property-name"></a> `name` | `readonly` | `"ChannelAccessConfigError"` | `'ChannelAccessConfigError'` | - | `Error.name` | - | [packages/channels/src/access.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/channels/src/access.ts#L94) |
