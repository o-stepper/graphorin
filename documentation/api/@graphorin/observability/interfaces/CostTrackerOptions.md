...
| <a id="property-oneviction"></a> `onEviction?` | `readonly` | (`event`) => `void` | W-092: observer for retention evictions (dashboards / warnings). | packages/observability/src/cost/types.ts:147 |
