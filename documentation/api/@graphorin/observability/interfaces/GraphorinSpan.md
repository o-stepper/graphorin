...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-id"></a> `id` | `readonly` | `string` | [`AISpan`](/api/@graphorin/core/interfaces/AISpan.md).[`id`](/api/@graphorin/core/interfaces/AISpan.md#property-id) | [packages/core/dist/contracts/tracer.d.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L76) |
| <a id="property-parentid"></a> `parentId?` | `readonly` | `string` | [`AISpan`](/api/@graphorin/core/interfaces/AISpan.md).[`parentId`](/api/@graphorin/core/interfaces/AISpan.md#property-parentid) | [packages/core/dist/contracts/tracer.d.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L78) |
| <a id="property-traceid"></a> `traceId` | `readonly` | `string` | [`AISpan`](/api/@graphorin/core/interfaces/AISpan.md).[`traceId`](/api/@graphorin/core/interfaces/AISpan.md#property-traceid) | [packages/core/dist/contracts/tracer.d.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L77) |
| <a id="property-type"></a> `type` | `readonly` | `T` | [`AISpan`](/api/@graphorin/core/interfaces/AISpan.md).[`type`](/api/@graphorin/core/interfaces/AISpan.md#property-type) | [packages/core/dist/contracts/tracer.d.ts:75](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L75) |
...
Defined in: [packages/core/dist/contracts/tracer.d.ts:88](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L88)
...
Defined in: [packages/core/dist/contracts/tracer.d.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L94)
...
Defined in: [packages/core/dist/contracts/tracer.d.ts:90](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L90)
...
Defined in: [packages/core/dist/contracts/tracer.d.ts:80](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L80)
...
Defined in: [packages/core/dist/contracts/tracer.d.ts:92](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/contracts/tracer.d.ts#L92)
