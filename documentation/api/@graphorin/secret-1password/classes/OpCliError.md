...
[Graphorin API reference](/api/index.md) / [@graphorin/secret-1password](/api/@graphorin/secret-1password/index.md) / [](/api/@graphorin/secret-1password/README.md) / OpCliError

# Class: OpCliError

Defined in: [packages/secret-1password/src/op-cli.ts:69](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L69)
...
Defined in: [packages/secret-1password/src/op-cli.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L76)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `kind` | [`OpCliErrorKind`](/api/@graphorin/secret-1password/type-aliases/OpCliErrorKind.md) |
| `message` | `string` |
| `options?` | \{ `cause?`: `unknown`; `exitCode?`: `number`; `hint?`: `string`; `stderr?`: `string`; \} |
...
| <a id="property-exitcode"></a> `exitCode?` | `readonly` | `number` | `undefined` | - | - | - | [packages/secret-1password/src/op-cli.ts:72](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L72) |
| <a id="property-hint"></a> `hint?` | `readonly` | `string` | `undefined` | - | - | - | [packages/secret-1password/src/op-cli.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L74) |
| <a id="property-kind"></a> `kind` | `readonly` | [`OpCliErrorKind`](/api/@graphorin/secret-1password/type-aliases/OpCliErrorKind.md) | `undefined` | - | - | - | [packages/secret-1password/src/op-cli.ts:71](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L71) |
...
| <a id="property-name"></a> `name` | `readonly` | `"OpCliError"` | `'OpCliError'` | - | `Error.name` | - | [packages/secret-1password/src/op-cli.ts:70](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L70) |
...
| <a id="property-stderr"></a> `stderr?` | `readonly` | `string` | `undefined` | - | - | - | [packages/secret-1password/src/op-cli.ts:73](https://github.com/o-stepper/graphorin/blob/main/packages/secret-1password/src/op-cli.ts#L73) |
