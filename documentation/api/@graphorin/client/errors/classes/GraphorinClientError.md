...
Defined in: packages/client/src/errors.ts:75
...
| <a id="property-kind"></a> `kind` | `readonly` | [`GraphorinClientErrorKind`](/api/@graphorin/client/errors/type-aliases/GraphorinClientErrorKind.md) | - | packages/client/src/errors.ts:76 |
