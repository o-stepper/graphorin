...
Defined in: packages/client/src/errors.ts:130
...
Defined in: packages/client/src/errors.ts:133
...
| <a id="property-subscriptionid"></a> `subscriptionId` | `readonly` | `string` | - | packages/client/src/errors.ts:131 |
