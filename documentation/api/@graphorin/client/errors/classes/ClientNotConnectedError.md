...
[Graphorin API reference](/api/index.md) / [@graphorin/client](/api/@graphorin/client/index.md) / [errors](/api/@graphorin/client/errors/index.md) / ClientNotConnectedError

# Class: ClientNotConnectedError

Defined in: [packages/client/src/errors.ts:86](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L86)
...
```ts
new ClientNotConnectedError(message?): ClientNotConnectedError;
```

Defined in: [packages/client/src/errors.ts:87](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L87)

#### Parameters

| Parameter | Type | Default value |
| ------ | ------ | ------ |
| `message` | `string` | `'GraphorinClient is not connected. Call connect() first.'` |
