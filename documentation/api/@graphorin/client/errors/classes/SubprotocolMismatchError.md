...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-actual"></a> `actual` | `readonly` | `string` \| `null` | - | packages/client/src/errors.ts:65 |
...
| <a id="property-expected"></a> `expected` | `readonly` | `string` | - | packages/client/src/errors.ts:64 |
