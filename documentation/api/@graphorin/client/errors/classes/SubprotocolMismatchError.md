...
[Graphorin API reference](/api/index.md) / [@graphorin/client](/api/@graphorin/client/index.md) / [errors](/api/@graphorin/client/errors/index.md) / SubprotocolMismatchError

# Class: SubprotocolMismatchError

Defined in: [packages/client/src/errors.ts:105](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L105)
...
Defined in: [packages/client/src/errors.ts:109](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L109)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-actual"></a> `actual` | `readonly` | `string` \| `null` | - | [packages/client/src/errors.ts:107](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L107) |
...
| <a id="property-expected"></a> `expected` | `readonly` | `string` | - | [packages/client/src/errors.ts:106](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L106) |
