...
[Graphorin API reference](/api/index.md) / [@graphorin/client](/api/@graphorin/client/index.md) / [errors](/api/@graphorin/client/errors/index.md) / InvalidServerFrameError

# Class: InvalidServerFrameError

Defined in: [packages/client/src/errors.ts:159](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L159)
...
```ts
new InvalidServerFrameError(message, issues): InvalidServerFrameError;
```

Defined in: [packages/client/src/errors.ts:162](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L162)
...
| <a id="property-issues"></a> `issues` | `readonly` | readonly \{ `message`: `string`; `path`: readonly (`string` \| `number`)[]; \}[] | - | [packages/client/src/errors.ts:160](https://github.com/o-stepper/graphorin/blob/main/packages/client/src/errors.ts#L160) |
