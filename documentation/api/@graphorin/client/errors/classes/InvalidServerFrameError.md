...
Defined in: packages/client/src/errors.ts:155
...
| <a id="property-issues"></a> `issues` | `readonly` | readonly \{ `message`: `string`; `path`: readonly (`string` \| `number`)[]; \}[] | - | packages/client/src/errors.ts:153 |
