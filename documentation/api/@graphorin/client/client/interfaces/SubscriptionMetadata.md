...
| <a id="property-queuedevents"></a> `queuedEvents` | `readonly` | `number` | W-152: current buffered (undelivered) event-frame count. | packages/client/src/graphorin-client.ts:190 |
