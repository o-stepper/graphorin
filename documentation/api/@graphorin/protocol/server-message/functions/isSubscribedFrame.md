...
[Graphorin API reference](/api/index.md) / [@graphorin/protocol](/api/@graphorin/protocol/index.md) / [server-message](/api/@graphorin/protocol/server-message/index.md) / isSubscribedFrame

# Function: isSubscribedFrame()
...
Defined in: src/server-message.ts:274
...
`message is { kind: "subscribed"; snapshotEventId?: string; subject: string; subscriptionId: string; v: "1" }`
