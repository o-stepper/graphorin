...
[Graphorin API reference](/api/index.md) / [@graphorin/protocol](/api/@graphorin/protocol/index.md) / [server-message](/api/@graphorin/protocol/server-message/index.md) / isLifecycleFrame

# Function: isLifecycleFrame()
...
Defined in: [packages/protocol/src/server-message.ts:208](https://github.com/o-stepper/graphorin/blob/main/packages/protocol/src/server-message.ts#L208)
