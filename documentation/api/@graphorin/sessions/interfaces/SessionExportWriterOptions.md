...
| <a id="property-writer"></a> `writer` | `readonly` | `string` | Writer identifier surfaced in the meta header (e.g. `'graphorin@0.4.0'`). | packages/sessions/src/export/writer.ts:29 |
