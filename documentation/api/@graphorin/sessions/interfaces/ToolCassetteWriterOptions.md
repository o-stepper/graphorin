...
[Graphorin API reference](/api/index.md) / [@graphorin/sessions](/api/@graphorin/sessions/index.md) / [](/api/@graphorin/sessions/README.md) / ToolCassetteWriterOptions
...
- [`ToolCassetteRecorderOptions`](/api/@graphorin/sessions/interfaces/ToolCassetteRecorderOptions.md)

## Properties

| Property | Modifier | Type | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="property-cipher"></a> `cipher?` | `readonly` | `"aes256gcm"` \| `"chacha20-poly1305"` | packages/sessions/src/cassette/writer.ts:43 |
...
| <a id="property-now"></a> `now?` | `readonly` | () => `number` | packages/sessions/src/cassette/writer.ts:44 |
