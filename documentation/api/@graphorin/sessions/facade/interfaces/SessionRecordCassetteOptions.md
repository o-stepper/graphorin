...
| <a id="property-runid"></a> `runId` | `readonly` | `string` | - | - | packages/sessions/src/facade.ts:292 |
...
| <a id="property-writer"></a> `writer?` | `readonly` | `string` | - | - | packages/sessions/src/facade.ts:293 |
