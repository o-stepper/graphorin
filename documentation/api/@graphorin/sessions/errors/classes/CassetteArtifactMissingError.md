...
Defined in: packages/sessions/src/errors/index.ts:120
...
Defined in: packages/sessions/src/errors/index.ts:123
...
| <a id="property-missingpath"></a> `missingPath` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:122 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:121 |
