...
Defined in: packages/sessions/src/errors/index.ts:115
...
Defined in: packages/sessions/src/errors/index.ts:118
...
| <a id="property-missingpath"></a> `missingPath` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:117 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:116 |
