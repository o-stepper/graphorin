...
Defined in: packages/sessions/src/errors/index.ts:265
...
Defined in: packages/sessions/src/errors/index.ts:267
...
| <a id="property-sessionid"></a> `sessionId` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:266 |
