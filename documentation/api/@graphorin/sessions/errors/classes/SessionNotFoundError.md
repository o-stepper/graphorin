...
Defined in: packages/sessions/src/errors/index.ts:260
...
Defined in: packages/sessions/src/errors/index.ts:262
...
| <a id="property-sessionid"></a> `sessionId` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:261 |
