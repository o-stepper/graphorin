...
Defined in: packages/sessions/src/errors/index.ts:259
...
Defined in: packages/sessions/src/errors/index.ts:261
...
| <a id="property-sessionid"></a> `sessionId` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:260 |
