...
Defined in: packages/sessions/src/errors/index.ts:100
...
Defined in: packages/sessions/src/errors/index.ts:103
...
| <a id="property-issues"></a> `issues` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:102 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:101 |
