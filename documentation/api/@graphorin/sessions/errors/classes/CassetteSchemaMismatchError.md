...
Defined in: packages/sessions/src/errors/index.ts:94
...
Defined in: packages/sessions/src/errors/index.ts:97
...
| <a id="property-issues"></a> `issues` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:96 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:95 |
