...
Defined in: packages/sessions/src/errors/index.ts:298
...
Defined in: packages/sessions/src/errors/index.ts:300
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-agentid"></a> `agentId` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:299 |
