...
Defined in: packages/sessions/src/errors/index.ts:76
...
Defined in: packages/sessions/src/errors/index.ts:80
...
| <a id="property-livesha256"></a> `liveSha256` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:79 |
...
| <a id="property-recordedsha256"></a> `recordedSha256` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:78 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:77 |
