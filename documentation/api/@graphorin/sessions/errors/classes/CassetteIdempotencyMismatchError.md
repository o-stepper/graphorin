...
Defined in: packages/sessions/src/errors/index.ts:70
...
Defined in: packages/sessions/src/errors/index.ts:74
...
| <a id="property-livesha256"></a> `liveSha256` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:73 |
...
| <a id="property-recordedsha256"></a> `recordedSha256` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:72 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:71 |
