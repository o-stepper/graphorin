...
Defined in: packages/sessions/src/errors/index.ts:229
...
Defined in: packages/sessions/src/errors/index.ts:232
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actual"></a> `actual` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:231 |
...
| <a id="property-expected"></a> `expected` | `readonly` | `string` | - | - | packages/sessions/src/errors/index.ts:230 |
