...
Defined in: [packages/tools/src/errors/index.ts:149](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L149)
...
Defined in: [packages/tools/src/errors/index.ts:155](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L155)
...
| <a id="property-failures"></a> `failures` | `readonly` | readonly \{ `error`: `unknown`; `toolCallId`: `string`; `toolName`: `string`; \}[] | - | - | [packages/tools/src/errors/index.ts:150](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L150) |
