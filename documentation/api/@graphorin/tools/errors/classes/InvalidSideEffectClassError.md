...
Defined in: [packages/tools/src/errors/index.ts:126](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L126)
...
Defined in: [packages/tools/src/errors/index.ts:129](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L129)
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | [packages/tools/src/errors/index.ts:127](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L127) |
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | [packages/tools/src/errors/index.ts:128](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L128) |
