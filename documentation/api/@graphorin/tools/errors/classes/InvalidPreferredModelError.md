...
Defined in: [packages/tools/src/errors/index.ts:101](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L101)
...
Defined in: [packages/tools/src/errors/index.ts:104](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L104)
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | [packages/tools/src/errors/index.ts:102](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L102) |
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | [packages/tools/src/errors/index.ts:103](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L103) |
