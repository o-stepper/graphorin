...
[Graphorin API reference](/api/index.md) / [@graphorin/tools](/api/@graphorin/tools/index.md) / [errors](/api/@graphorin/tools/errors/index.md) / InvalidExampleError

# Class: InvalidExampleError

Defined in: [packages/tools/src/errors/index.ts:62](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L62)
...
```ts
new InvalidExampleError(opts): InvalidExampleError;
```

Defined in: [packages/tools/src/errors/index.ts:67](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L67)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `opts` | \{ `exampleIndex`: `number`; `field`: `"input"` \| `"output"`; `toolName`: `string`; `validationError`: `unknown`; \} |
| `opts.exampleIndex` | `number` |
| `opts.field` | `"input"` \| `"output"` |
| `opts.toolName` | `string` |
| `opts.validationError` | `unknown` |
...
| <a id="property-exampleindex"></a> `exampleIndex` | `readonly` | `number` | - | - | [packages/tools/src/errors/index.ts:64](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L64) |
| <a id="property-field"></a> `field` | `readonly` | `"input"` \| `"output"` | - | - | [packages/tools/src/errors/index.ts:65](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L65) |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | [packages/tools/src/errors/index.ts:63](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L63) |
| <a id="property-validationerror"></a> `validationError` | `readonly` | `unknown` | - | - | [packages/tools/src/errors/index.ts:66](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/errors/index.ts#L66) |
