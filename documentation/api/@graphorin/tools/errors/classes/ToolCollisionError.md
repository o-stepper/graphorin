...
Defined in: packages/tools/src/errors/index.ts:174
...
Defined in: packages/tools/src/errors/index.ts:178
...
| <a id="property-conflictingsources"></a> `conflictingSources` | `readonly` | readonly `string`[] | - | - | packages/tools/src/errors/index.ts:176 |
...
| <a id="property-strategyattempted"></a> `strategyAttempted` | `readonly` | `string` | - | - | packages/tools/src/errors/index.ts:177 |
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/tools/src/errors/index.ts:175 |
