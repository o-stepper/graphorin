...
Defined in: [packages/tools/src/executor/tool-errors.ts:24](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/executor/tool-errors.ts#L24)
...
Defined in: [packages/tools/src/executor/tool-errors.ts:28](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/executor/tool-errors.ts#L28)
...
| <a id="property-retryafterms"></a> `retryAfterMs?` | `readonly` | `number` | Milliseconds the caller should wait before retrying, when known. | - | [packages/tools/src/executor/tool-errors.ts:26](https://github.com/o-stepper/graphorin/blob/main/packages/tools/src/executor/tool-errors.ts#L26) |
