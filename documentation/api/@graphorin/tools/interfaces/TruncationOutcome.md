...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-artifactbytes"></a> `artifactBytes?` | `readonly` | `number` | Bytes written to the spill artifact (only set for `'spill-to-file'`). | packages/tools/src/result/truncate.ts:62 |
| <a id="property-artifactpath"></a> `artifactPath?` | `readonly` | `string` | Path of the spill artifact (only set for `'spill-to-file'`). | packages/tools/src/result/truncate.ts:60 |
| <a id="property-body"></a> `body` | `readonly` | `string` | - | packages/tools/src/result/truncate.ts:54 |
