...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-artifactroot"></a> `artifactRoot` | `readonly` | `string` | Root the spill writer writes under (e.g. `SpillWriter.artifactRoot`). | packages/tools/src/result/reader.ts:73 |
| <a id="property-maxbytes"></a> `maxBytes?` | `readonly` | `number` | Default `maxBytes` when the caller omits one. Default `65536`. | packages/tools/src/result/reader.ts:75 |
