...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-deferloadingbydefault"></a> `deferLoadingByDefault?` | `readonly` | `boolean` | C6: treat tools that do not declare `defer_loading` as deferred (the minimal-scaffold posture). An explicit `defer_loading: false` on the tool still wins. Default `false` (per-tool opt-in). | packages/tools/src/registry/registry.ts:71 |
