...
| <a id="property-producersensitivity"></a> `producerSensitivity?` | `readonly` | [`Sensitivity`](/api/@graphorin/core/type-aliases/Sensitivity.md) | Sensitivity of the produced content, when the reader knows it (tools-03). | packages/tools/src/result/reader.ts:72 |
| <a id="property-producersource"></a> `producerSource?` | `readonly` | [`ToolSource`](/api/@graphorin/core/type-aliases/ToolSource.md) | Source of the producing tool, when the reader knows it (tools-03). | packages/tools/src/result/reader.ts:70 |
