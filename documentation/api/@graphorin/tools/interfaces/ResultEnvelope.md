...
| <a id="property-taint"></a> `taint?` | `readonly` | \{ `sensitive?`: `boolean`; `sourceKind?`: `string`; `untrusted?`: `boolean`; \} | C6: per-result taint override carried from the ToolReturn envelope. | packages/tools/src/result/envelope.ts:29 |
