...
| ------ | ------ | ------ | ------ |
| <a id="property-registered"></a> `registered` | `readonly` | readonly \{ `id`: `string`; `kind`: `"turn"` \| `"idle"` \| `"cron"` \| `"event"` \| `"budget"` \| `"buffer"`; `raw`: `string`; \}[] | [packages/memory/src/consolidator/scheduler.ts:113](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/scheduler.ts#L113) |
