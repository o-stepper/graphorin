...
| <a id="property-candidatetopk"></a> `candidateTopK?` | `readonly` | `number` | Override the per-list candidate count (default `60`). | packages/memory/src/tiers/semantic-memory.ts:106 |
...
| <a id="property-signal"></a> `signal?` | `readonly` | `AbortSignal` | - | packages/memory/src/tiers/semantic-memory.ts:104 |
| <a id="property-topk"></a> `topK?` | `readonly` | `number` | - | packages/memory/src/tiers/semantic-memory.ts:103 |
