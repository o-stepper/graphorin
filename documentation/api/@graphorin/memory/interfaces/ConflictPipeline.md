...
Defined in: packages/memory/src/conflict/types.ts:201
...
| ------ | ------ | ------ | ------ |
| <a id="property-localepack"></a> `localePack` | `readonly` | [`LocalePack`](/api/@graphorin/memory/interfaces/LocalePack.md) | packages/memory/src/conflict/types.ts:203 |
| <a id="property-mode"></a> `mode` | `readonly` | `"on"` \| `"off"` | packages/memory/src/conflict/types.ts:202 |
| <a id="property-thresholds"></a> `thresholds` | `readonly` | [`ConflictThresholds`](/api/@graphorin/memory/interfaces/ConflictThresholds.md) | packages/memory/src/conflict/types.ts:204 |
...
Defined in: packages/memory/src/conflict/types.ts:205
