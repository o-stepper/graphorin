...
| ------ | ------ | ------ | ------ |
| <a id="property-deep"></a> `deep?` | `readonly` | `string` | packages/memory/src/consolidator/types.ts:328 |
| <a id="property-light"></a> `light?` | `readonly` | `string` | packages/memory/src/consolidator/types.ts:326 |
| <a id="property-standard"></a> `standard?` | `readonly` | `string` | packages/memory/src/consolidator/types.ts:327 |
