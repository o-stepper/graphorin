...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-entity"></a> `entity?` | `readonly` | `number` | Weight applied to the exact entity-match candidate list (D5). Default `1`. | packages/memory/src/tiers/semantic-memory.ts:105 |
