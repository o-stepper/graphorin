...
Defined in: packages/memory/src/tiers/semantic-memory.ts:337
...
| <a id="property-pipeline"></a> `pipeline?` | `readonly` | `"on"` \| `"off"` | - | packages/memory/src/tiers/semantic-memory.ts:338 |
| <a id="property-signal"></a> `signal?` | `readonly` | `AbortSignal` | Cancellation signal forwarded to the embedder + storage layers. | packages/memory/src/tiers/semantic-memory.ts:340 |
