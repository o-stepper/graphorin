...
| <a id="property-keeptooluses"></a> `keepToolUses?` | `readonly` | `number` | Most-recent tool results kept verbatim (default DEFAULT\_KEEP\_TOOL\_USES). | packages/memory/src/context-engine/compaction/clear-tool-results.ts:30 |
