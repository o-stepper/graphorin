...
| <a id="property-owner"></a> `owner?` | `readonly` | [`MemoryOwner`](/api/@graphorin/core/type-aliases/MemoryOwner.md) | Principal dimension. `'agent'` on auto-formed episodes. | packages/memory/src/tiers/episodic-memory.ts:47 |
| <a id="property-provenance"></a> `provenance?` | `readonly` | [`MemoryProvenance`](/api/@graphorin/core/type-aliases/MemoryProvenance.md) | Trust-provenance tag. Episodes auto-formed by the consolidator pass `'extraction'` so they land quarantined; omit (defaults to first-party `active`) for user-authored episodes. | packages/memory/src/tiers/episodic-memory.ts:39 |
