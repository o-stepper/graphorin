...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / DEFAULT\_PRESERVE\_RECENT\_TURNS

# Variable: DEFAULT\_PRESERVE\_RECENT\_TURNS
