...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / BASE\_TEMPLATE\_EN\_MINIMAL

# Variable: BASE\_TEMPLATE\_EN\_MINIMAL
