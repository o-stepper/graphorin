...
Defined in: [packages/memory/src/errors/index.ts:82](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L82)
...
Defined in: [packages/memory/src/errors/index.ts:89](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L89)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-attempted"></a> `attempted` | `readonly` | `number` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:86](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L86) |
...
| <a id="property-charlimit"></a> `charLimit` | `readonly` | `number` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:87](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L87) |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"working-block-overflow"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/errors/index.ts:84](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L84) |
| <a id="property-label"></a> `label` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:85](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L85) |
...
| <a id="property-name"></a> `name` | `readonly` | `"WorkingBlockOverflowError"` | `'WorkingBlockOverflowError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:83](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L83) |
