...
Defined in: [packages/memory/src/errors/index.ts:155](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L155)
...
Defined in: [packages/memory/src/errors/index.ts:161](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L161)
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationLockedError"` | `'EmbedderMigrationLockedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:156](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L156) |
| <a id="property-source"></a> `source` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:158](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L158) |
...
| <a id="property-target"></a> `target` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:159](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L159) |
