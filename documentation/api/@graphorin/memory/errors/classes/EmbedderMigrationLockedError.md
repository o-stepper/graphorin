...
Defined in: packages/memory/src/errors/index.ts:133
...
Defined in: packages/memory/src/errors/index.ts:139
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationLockedError"` | `'EmbedderMigrationLockedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:134 |
| <a id="property-source"></a> `source` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:136 |
...
| <a id="property-target"></a> `target` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:137 |
