...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / EmbedderMigrationLockedError

# Class: EmbedderMigrationLockedError

Defined in: packages/memory/src/errors/index.ts:155
...
```ts
new EmbedderMigrationLockedError(source, target): EmbedderMigrationLockedError;
```

Defined in: packages/memory/src/errors/index.ts:161
...
| <a id="property-kind"></a> `kind` | `readonly` | `"embedder-migration-locked"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/errors/index.ts:157 |
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationLockedError"` | `'EmbedderMigrationLockedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:156 |
| <a id="property-source"></a> `source` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:158 |
...
| <a id="property-target"></a> `target` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:159 |
