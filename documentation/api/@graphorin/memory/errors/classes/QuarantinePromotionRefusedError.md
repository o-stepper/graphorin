...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / QuarantinePromotionRefusedError

# Class: QuarantinePromotionRefusedError

Defined in: [packages/memory/src/errors/index.ts:227](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L227)
...
```ts
new QuarantinePromotionRefusedError(factId, markers): QuarantinePromotionRefusedError;
```

Defined in: [packages/memory/src/errors/index.ts:234](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L234)
...
| <a id="property-factid"></a> `factId` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:230](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L230) |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"quarantine-promotion-refused"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/errors/index.ts:229](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L229) |
| <a id="property-markers"></a> `markers` | `readonly` | readonly `string`[] | `undefined` | Injection-rule labels that tripped on the fact's text. | - | - | [packages/memory/src/errors/index.ts:232](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L232) |
...
| <a id="property-name"></a> `name` | `readonly` | `"QuarantinePromotionRefusedError"` | `'QuarantinePromotionRefusedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:228](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L228) |
