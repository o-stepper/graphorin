...
Defined in: packages/memory/src/errors/index.ts:234
...
| <a id="property-factid"></a> `factId` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:230 |
...
| <a id="property-name"></a> `name` | `readonly` | `"QuarantinePromotionRefusedError"` | `'QuarantinePromotionRefusedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:228 |
