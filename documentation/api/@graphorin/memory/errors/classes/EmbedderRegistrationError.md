...
Defined in: [packages/memory/src/errors/index.ts:36](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L36)
...
Defined in: [packages/memory/src/errors/index.ts:41](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L41)
...
| <a id="property-embedderid"></a> `embedderId` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:39](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L39) |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"embedder-registration"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/errors/index.ts:38](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L38) |
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderRegistrationError"` | `'EmbedderRegistrationError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:37](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L37) |
