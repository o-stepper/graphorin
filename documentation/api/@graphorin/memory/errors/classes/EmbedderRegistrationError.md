...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / EmbedderRegistrationError

# Class: EmbedderRegistrationError

Defined in: packages/memory/src/errors/index.ts:36
...
```ts
new EmbedderRegistrationError(embedderId, options?): EmbedderRegistrationError;
```

Defined in: packages/memory/src/errors/index.ts:41
...
| <a id="property-embedderid"></a> `embedderId` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:39 |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"embedder-registration"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/errors/index.ts:38 |
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderRegistrationError"` | `'EmbedderRegistrationError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:37 |
