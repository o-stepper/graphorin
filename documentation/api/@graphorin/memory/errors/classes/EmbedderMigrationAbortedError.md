...
Defined in: [packages/memory/src/errors/index.ts:182](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L182)
...
Defined in: [packages/memory/src/errors/index.ts:187](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L187)
...
| <a id="property-migrationid"></a> `migrationId` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:185](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L185) |
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationAbortedError"` | `'EmbedderMigrationAbortedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:183](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L183) |
