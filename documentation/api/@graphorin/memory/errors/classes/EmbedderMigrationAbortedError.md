...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / EmbedderMigrationAbortedError

# Class: EmbedderMigrationAbortedError

Defined in: packages/memory/src/errors/index.ts:182
...
```ts
new EmbedderMigrationAbortedError(migrationId): EmbedderMigrationAbortedError;
```

Defined in: packages/memory/src/errors/index.ts:187
...
| <a id="property-kind"></a> `kind` | `readonly` | `"embedder-migration-aborted"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/errors/index.ts:184 |
...
| <a id="property-migrationid"></a> `migrationId` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:185 |
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationAbortedError"` | `'EmbedderMigrationAbortedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:183 |
