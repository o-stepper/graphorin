...
Defined in: packages/memory/src/errors/index.ts:160
...
Defined in: packages/memory/src/errors/index.ts:165
...
| <a id="property-migrationid"></a> `migrationId` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:163 |
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationAbortedError"` | `'EmbedderMigrationAbortedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:161 |
