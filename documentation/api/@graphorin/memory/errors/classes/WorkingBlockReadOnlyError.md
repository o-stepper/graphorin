...
Defined in: [packages/memory/src/errors/index.ts:136](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L136)
...
Defined in: [packages/memory/src/errors/index.ts:141](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L141)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"working-block-read-only"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/errors/index.ts:138](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L138) |
| <a id="property-label"></a> `label` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:139](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L139) |
...
| <a id="property-name"></a> `name` | `readonly` | `"WorkingBlockReadOnlyError"` | `'WorkingBlockReadOnlyError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:137](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L137) |
