...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / WorkingBlockReadOnlyError

# Class: WorkingBlockReadOnlyError

Defined in: packages/memory/src/errors/index.ts:136
...
```ts
new WorkingBlockReadOnlyError(label): WorkingBlockReadOnlyError;
```

Defined in: packages/memory/src/errors/index.ts:141
...
| <a id="property-kind"></a> `kind` | `readonly` | `"working-block-read-only"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/errors/index.ts:138 |
| <a id="property-label"></a> `label` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:139 |
...
| <a id="property-name"></a> `name` | `readonly` | `"WorkingBlockReadOnlyError"` | `'WorkingBlockReadOnlyError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:137 |
