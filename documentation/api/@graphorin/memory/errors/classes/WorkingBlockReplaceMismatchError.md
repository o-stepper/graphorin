...
Defined in: packages/memory/src/errors/index.ts:109
...
Defined in: packages/memory/src/errors/index.ts:115
...
| <a id="property-name"></a> `name` | `readonly` | `"WorkingBlockReplaceMismatchError"` | `'WorkingBlockReplaceMismatchError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:110 |
| <a id="property-occurrences"></a> `occurrences` | `readonly` | `number` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:113 |
