...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / WorkingBlockReplaceMismatchError

# Class: WorkingBlockReplaceMismatchError

Defined in: [packages/memory/src/errors/index.ts:109](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L109)
...
```ts
new WorkingBlockReplaceMismatchError(label, occurrences): WorkingBlockReplaceMismatchError;
```

Defined in: [packages/memory/src/errors/index.ts:115](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L115)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"working-block-replace-mismatch"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/errors/index.ts:111](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L111) |
| <a id="property-label"></a> `label` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:112](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L112) |
...
| <a id="property-name"></a> `name` | `readonly` | `"WorkingBlockReplaceMismatchError"` | `'WorkingBlockReplaceMismatchError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:110](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L110) |
| <a id="property-occurrences"></a> `occurrences` | `readonly` | `number` | `undefined` | - | - | - | [packages/memory/src/errors/index.ts:113](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L113) |
