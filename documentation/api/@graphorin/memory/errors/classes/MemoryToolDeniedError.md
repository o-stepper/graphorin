...
Defined in: packages/memory/src/errors/index.ts:61
...
Defined in: packages/memory/src/errors/index.ts:67
...
| <a id="property-kind"></a> `kind` | `readonly` | `"memory-tool-denied"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/errors/index.ts:63 |
...
| <a id="property-name"></a> `name` | `readonly` | `"MemoryToolDeniedError"` | `'MemoryToolDeniedError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:62 |
| <a id="property-reason"></a> `reason` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:65 |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | `undefined` | - | - | - | packages/memory/src/errors/index.ts:64 |
