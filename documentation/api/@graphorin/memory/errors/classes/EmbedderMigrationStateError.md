...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [errors](/api/@graphorin/memory/errors/index.md) / EmbedderMigrationStateError

# Class: EmbedderMigrationStateError

Defined in: packages/memory/src/errors/index.ts:184
...
```ts
new EmbedderMigrationStateError(message): EmbedderMigrationStateError;
```

Defined in: packages/memory/src/errors/index.ts:188
...
| <a id="property-kind"></a> `kind` | `readonly` | `"embedder-migration-state"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/errors/index.ts:186 |
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationStateError"` | `'EmbedderMigrationStateError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/errors/index.ts:185 |
