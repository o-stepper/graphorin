...
Defined in: [packages/memory/src/errors/index.ts:206](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L206)
...
Defined in: [packages/memory/src/errors/index.ts:210](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L210)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"embedder-migration-state"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/errors/index.ts:208](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L208) |
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderMigrationStateError"` | `'EmbedderMigrationStateError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/errors/index.ts:207](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/errors/index.ts#L207) |
