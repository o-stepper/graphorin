...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / renderMetadataBlock
...
| Parameter | Type |
| ------ | ------ |
| `meta` | [`MemoryMetadata`](/api/@graphorin/core/interfaces/MemoryMetadata.md) |
