...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / CuratedBlocksMisconfiguredError

# Class: CuratedBlocksMisconfiguredError

Defined in: [packages/memory/src/consolidator/errors.ts:75](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L75)
...
```ts
new CuratedBlocksMisconfiguredError(label, problem): CuratedBlocksMisconfiguredError;
```

Defined in: [packages/memory/src/consolidator/errors.ts:80](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L80)
...
| ------ | ------ |
| `label` | `string` |
| `problem` | `"duplicate"` \| `"empty"` \| `"reserved"` |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"curated-blocks-misconfigured"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/consolidator/errors.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L77) |
| <a id="property-label"></a> `label` | `readonly` | `string` | `undefined` | - | - | - | [packages/memory/src/consolidator/errors.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L78) |
...
| <a id="property-name"></a> `name` | `readonly` | `"CuratedBlocksMisconfiguredError"` | `'CuratedBlocksMisconfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/consolidator/errors.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L76) |
