...
Defined in: packages/memory/src/consolidator/errors.ts:73
...
Defined in: packages/memory/src/consolidator/errors.ts:78
...
| <a id="property-name"></a> `name` | `readonly` | `"ProviderNotConfiguredError"` | `'ProviderNotConfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/consolidator/errors.ts:74 |
| <a id="property-phase"></a> `phase` | `readonly` | [`ConsolidatorPhase`](/api/@graphorin/memory/type-aliases/ConsolidatorPhase.md) | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:76 |
