...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / ProviderNotConfiguredError

# Class: ProviderNotConfiguredError

Defined in: packages/memory/src/consolidator/errors.ts:129
...
```ts
new ProviderNotConfiguredError(phase): ProviderNotConfiguredError;
```

Defined in: packages/memory/src/consolidator/errors.ts:134
...
| <a id="property-kind"></a> `kind` | `readonly` | `"provider-not-configured"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/consolidator/errors.ts:131 |
...
| <a id="property-name"></a> `name` | `readonly` | `"ProviderNotConfiguredError"` | `'ProviderNotConfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/consolidator/errors.ts:130 |
| <a id="property-phase"></a> `phase` | `readonly` | [`ConsolidatorPhase`](/api/@graphorin/memory/type-aliases/ConsolidatorPhase.md) | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:132 |
