...
Defined in: [packages/memory/src/consolidator/errors.ts:129](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L129)
...
Defined in: [packages/memory/src/consolidator/errors.ts:134](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L134)
...
| <a id="property-name"></a> `name` | `readonly` | `"ProviderNotConfiguredError"` | `'ProviderNotConfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/consolidator/errors.ts:130](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L130) |
| <a id="property-phase"></a> `phase` | `readonly` | [`ConsolidatorPhase`](/api/@graphorin/memory/type-aliases/ConsolidatorPhase.md) | `undefined` | - | - | - | [packages/memory/src/consolidator/errors.ts:132](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L132) |
