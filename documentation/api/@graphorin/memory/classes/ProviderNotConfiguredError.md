...
Defined in: [packages/memory/src/consolidator/errors.ts:73](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L73)
...
Defined in: [packages/memory/src/consolidator/errors.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L78)
...
| <a id="property-name"></a> `name` | `readonly` | `"ProviderNotConfiguredError"` | `'ProviderNotConfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/consolidator/errors.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L74) |
| <a id="property-phase"></a> `phase` | `readonly` | [`ConsolidatorPhase`](/api/@graphorin/memory/type-aliases/ConsolidatorPhase.md) | `undefined` | - | - | - | [packages/memory/src/consolidator/errors.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L76) |
