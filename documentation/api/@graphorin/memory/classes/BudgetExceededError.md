...
Defined in: packages/memory/src/consolidator/errors.ts:18
...
Defined in: packages/memory/src/consolidator/errors.ts:26
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actual"></a> `actual` | `readonly` | `number` | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:23 |
| <a id="property-budget"></a> `budget` | `readonly` | `number` | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:22 |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"budget-exceeded"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | packages/memory/src/consolidator/errors.ts:20 |
...
| <a id="property-name"></a> `name` | `readonly` | `"BudgetExceededError"` | `'BudgetExceededError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/consolidator/errors.ts:19 |
| <a id="property-phase"></a> `phase` | `readonly` | [`ConsolidatorPhase`](/api/@graphorin/memory/type-aliases/ConsolidatorPhase.md) | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:21 |
| <a id="property-resource"></a> `resource` | `readonly` | `"tokens"` \| `"cost"` | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:24 |
