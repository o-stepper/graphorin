...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / CustomTierMisconfiguredError

# Class: CustomTierMisconfiguredError

Defined in: packages/memory/src/consolidator/errors.ts:50
...
```ts
new CustomTierMisconfiguredError(missing): CustomTierMisconfiguredError;
```

Defined in: packages/memory/src/consolidator/errors.ts:55
...
| <a id="property-missing"></a> `missing` | `readonly` | readonly `string`[] | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:53 |
| <a id="property-name"></a> `name` | `readonly` | `"CustomTierMisconfiguredError"` | `'CustomTierMisconfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/consolidator/errors.ts:51 |
