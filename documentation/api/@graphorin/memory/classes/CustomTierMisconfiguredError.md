...
Defined in: [packages/memory/src/consolidator/errors.ts:50](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L50)
...
Defined in: [packages/memory/src/consolidator/errors.ts:55](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L55)
...
| <a id="property-missing"></a> `missing` | `readonly` | readonly `string`[] | `undefined` | - | - | - | [packages/memory/src/consolidator/errors.ts:53](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L53) |
| <a id="property-name"></a> `name` | `readonly` | `"CustomTierMisconfiguredError"` | `'CustomTierMisconfiguredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/consolidator/errors.ts:51](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L51) |
