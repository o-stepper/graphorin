...
| `args.trustWeights?` | [`SalienceWeights`](/api/@graphorin/memory/interfaces/SalienceWeights.md) | Weights for the rank-time trust discount. Reuses the eviction-path `SalienceWeights` semantics; defaults to `DEFAULT_SALIENCE_WEIGHTS`. |
