...
Defined in: packages/memory/src/consolidator/errors.ts:105
...
Defined in: packages/memory/src/consolidator/errors.ts:110
...
| <a id="property-feature"></a> `feature` | `readonly` | `"promotion"` \| `"autoPromoteExtraction"` | `undefined` | - | - | - | packages/memory/src/consolidator/errors.ts:108 |
...
| <a id="property-name"></a> `name` | `readonly` | `"IngestGateRequiredError"` | `'IngestGateRequiredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | packages/memory/src/consolidator/errors.ts:106 |
