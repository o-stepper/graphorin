...
[Graphorin API reference](/api/index.md) / [@graphorin/memory](/api/@graphorin/memory/index.md) / [](/api/@graphorin/memory/README.md) / IngestGateRequiredError

# Class: IngestGateRequiredError

Defined in: [packages/memory/src/consolidator/errors.ts:105](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L105)
...
```ts
new IngestGateRequiredError(feature): IngestGateRequiredError;
```

Defined in: [packages/memory/src/consolidator/errors.ts:110](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L110)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `feature` | `"promotion"` \| `"autoPromoteExtraction"` |
...
| <a id="property-feature"></a> `feature` | `readonly` | `"promotion"` \| `"autoPromoteExtraction"` | `undefined` | - | - | - | [packages/memory/src/consolidator/errors.ts:108](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L108) |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"ingest-gate-required"` | `undefined` | Stable lowercase discriminator. | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`kind`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-kind) | - | [packages/memory/src/consolidator/errors.ts:107](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L107) |
...
| <a id="property-name"></a> `name` | `readonly` | `"IngestGateRequiredError"` | `'IngestGateRequiredError'` | - | [`GraphorinMemoryError`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md).[`name`](/api/@graphorin/memory/errors/classes/GraphorinMemoryError.md#property-name) | - | [packages/memory/src/consolidator/errors.ts:106](https://github.com/o-stepper/graphorin/blob/main/packages/memory/src/consolidator/errors.ts#L106) |
