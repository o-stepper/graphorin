...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPToolNotFoundError

# Class: MCPToolNotFoundError

Defined in: packages/mcp/src/errors/index.ts:92
...
```ts
new MCPToolNotFoundError(message, opts?): MCPToolNotFoundError;
```
...
| <a id="property-kind"></a> `kind` | `readonly` | `"tool-not-found"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:93 |
