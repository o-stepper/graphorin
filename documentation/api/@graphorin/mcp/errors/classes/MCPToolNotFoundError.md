...
Defined in: [packages/mcp/src/errors/index.ts:92](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L92)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"tool-not-found"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:93](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L93) |
