...
Defined in: [packages/mcp/src/errors/index.ts:142](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L142)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"invalid-config"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:143](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L143) |
