...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPCallTimeoutError

# Class: MCPCallTimeoutError

Defined in: [packages/mcp/src/errors/index.ts:117](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L117)
...
```ts
new MCPCallTimeoutError(message, opts): MCPCallTimeoutError;
```

Defined in: [packages/mcp/src/errors/index.ts:120](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L120)
...
| ------ | ------ |
| `message` | `string` |
| `opts` | \{ `cause?`: `unknown`; `hint?`: `string`; `metadata?`: [`MCPErrorMetadata`](/api/@graphorin/mcp/errors/interfaces/MCPErrorMetadata.md); `variant?`: `"call-timeout"` \| `"session-lost"`; \} |
| `opts.cause?` | `unknown` |
| `opts.hint?` | `string` |
| `opts.metadata?` | [`MCPErrorMetadata`](/api/@graphorin/mcp/errors/interfaces/MCPErrorMetadata.md) |
| `opts.variant?` | `"call-timeout"` \| `"session-lost"` |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"call-timeout"` \| `"session-lost"` | `'call-timeout'` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:118](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L118) |
