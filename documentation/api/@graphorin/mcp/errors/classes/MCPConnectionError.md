...
Defined in: [packages/mcp/src/errors/index.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L77)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"connection-failed"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L78) |
