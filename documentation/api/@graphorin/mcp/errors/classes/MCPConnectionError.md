...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPConnectionError

# Class: MCPConnectionError

Defined in: packages/mcp/src/errors/index.ts:77
...
```ts
new MCPConnectionError(message, opts?): MCPConnectionError;
```
...
| <a id="property-kind"></a> `kind` | `readonly` | `"connection-failed"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:78 |
