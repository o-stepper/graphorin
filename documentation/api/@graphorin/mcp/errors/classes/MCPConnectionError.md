...
Defined in: packages/mcp/src/errors/index.ts:75
...
| <a id="property-kind"></a> `kind` | `readonly` | `"connection-failed"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:76 |
