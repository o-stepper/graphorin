...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPTransportNotSupportedError

# Class: MCPTransportNotSupportedError

Defined in: [packages/mcp/src/errors/index.ts:152](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L152)
...
```ts
new MCPTransportNotSupportedError(message, opts): MCPTransportNotSupportedError;
```

Defined in: [packages/mcp/src/errors/index.ts:156](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L156)
...
| ------ | ------ |
| `message` | `string` |
| `opts` | \{ `cause?`: `unknown`; `hint?`: `string`; `metadata?`: [`MCPErrorMetadata`](/api/@graphorin/mcp/errors/interfaces/MCPErrorMetadata.md); `variant?`: `"transport-not-supported"` \| `"transport-resumable-not-supported"`; \} |
| `opts.cause?` | `unknown` |
| `opts.hint?` | `string` |
| `opts.metadata?` | [`MCPErrorMetadata`](/api/@graphorin/mcp/errors/interfaces/MCPErrorMetadata.md) |
| `opts.variant?` | `"transport-not-supported"` \| `"transport-resumable-not-supported"` |
