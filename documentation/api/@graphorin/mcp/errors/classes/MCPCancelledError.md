...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPCancelledError

# Class: MCPCancelledError

Defined in: packages/mcp/src/errors/index.ts:137
...
```ts
new MCPCancelledError(message, opts?): MCPCancelledError;
```
...
| <a id="property-kind"></a> `kind` | `readonly` | `"cancelled"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:138 |
