...
Defined in: [packages/mcp/src/errors/index.ts:137](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L137)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"cancelled"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:138](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L138) |
