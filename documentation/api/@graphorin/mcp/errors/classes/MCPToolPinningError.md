...
Defined in: [packages/mcp/src/errors/index.ts:101](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L101)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"pin-mismatch"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:102](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L102) |
