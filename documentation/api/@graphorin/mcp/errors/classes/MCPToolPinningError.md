...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPToolPinningError

# Class: MCPToolPinningError
...
```ts
new MCPToolPinningError(message, opts?): MCPToolPinningError;
```
...
| <a id="property-kind"></a> `kind` | `readonly` | `"pin-mismatch"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:102 |
