...
Defined in: packages/mcp/src/errors/index.ts:85
...
| <a id="property-kind"></a> `kind` | `readonly` | `"auth-error"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:86 |
