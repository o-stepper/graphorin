...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPAuthError

# Class: MCPAuthError

Defined in: packages/mcp/src/errors/index.ts:87
...
```ts
new MCPAuthError(message, opts?): MCPAuthError;
```
...
| <a id="property-kind"></a> `kind` | `readonly` | `"auth-error"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:88 |
