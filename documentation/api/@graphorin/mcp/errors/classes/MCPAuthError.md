...
Defined in: [packages/mcp/src/errors/index.ts:87](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L87)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"auth-error"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:88](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L88) |
