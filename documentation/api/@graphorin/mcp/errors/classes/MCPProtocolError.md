...
[Graphorin API reference](/api/index.md) / [@graphorin/mcp](/api/@graphorin/mcp/index.md) / [errors](/api/@graphorin/mcp/errors/index.md) / MCPProtocolError

# Class: MCPProtocolError

Defined in: packages/mcp/src/errors/index.ts:82
...
```ts
new MCPProtocolError(message, opts?): MCPProtocolError;
```
...
| <a id="property-kind"></a> `kind` | `readonly` | `"protocol-error"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | packages/mcp/src/errors/index.ts:83 |
