...
Defined in: [packages/mcp/src/errors/index.ts:82](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L82)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"protocol-error"` | Lowercase discriminator. | [`GraphorinMCPError`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md).[`kind`](/api/@graphorin/mcp/errors/classes/GraphorinMCPError.md#property-kind) | - | [packages/mcp/src/errors/index.ts:83](https://github.com/o-stepper/graphorin/blob/main/packages/mcp/src/errors/index.ts#L83) |
