...
Defined in: packages/mcp/src/client/types.ts:304
...
| ------ | ------ | ------ | ------ |
| `description?` | `string` | - | packages/mcp/src/client/types.ts:329 |
| `mimeType?` | `string` | - | packages/mcp/src/client/types.ts:330 |
| `name` | `string` | - | packages/mcp/src/client/types.ts:327 |
| `size?` | `number` | - | packages/mcp/src/client/types.ts:331 |
| `title?` | `string` | - | packages/mcp/src/client/types.ts:328 |
...
| `uri` | `string` | - | packages/mcp/src/client/types.ts:326 |
