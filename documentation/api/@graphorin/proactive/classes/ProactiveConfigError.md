...
Defined in: [packages/proactive/src/errors.ts:16](https://github.com/o-stepper/graphorin/blob/main/packages/proactive/src/errors.ts#L16)
...
Defined in: [packages/proactive/src/errors.ts:18](https://github.com/o-stepper/graphorin/blob/main/packages/proactive/src/errors.ts#L18)
...
| <a id="property-name"></a> `name` | `readonly` | `"ProactiveConfigError"` | `'ProactiveConfigError'` | - | `Error.name` | - | [packages/proactive/src/errors.ts:17](https://github.com/o-stepper/graphorin/blob/main/packages/proactive/src/errors.ts#L17) |
| <a id="property-rule"></a> `rule` | `readonly` | \| `"act-requires-ingest-gate"` \| `"recursive-scheduling"` \| `"invalid-options"` | `undefined` | - | - | - | [packages/proactive/src/errors.ts:20](https://github.com/o-stepper/graphorin/blob/main/packages/proactive/src/errors.ts#L20) |
...
| <a id="property-taskid"></a> `taskId` | `readonly` | `string` | `undefined` | - | - | - | [packages/proactive/src/errors.ts:19](https://github.com/o-stepper/graphorin/blob/main/packages/proactive/src/errors.ts#L19) |
