...
Defined in: packages/provider/src/errors/errors.ts:146
...
Defined in: packages/provider/src/errors/errors.ts:152
...
| <a id="property-role"></a> `role?` | `readonly` | `string` | `undefined` | - | - | - | packages/provider/src/errors/errors.ts:150 |
