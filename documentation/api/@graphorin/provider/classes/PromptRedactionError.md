...
[Graphorin API reference](/api/index.md) / [@graphorin/provider](/api/@graphorin/provider/index.md) / [](/api/@graphorin/provider/README.md) / PromptRedactionError

# Class: PromptRedactionError

Defined in: [packages/provider/src/errors/errors.ts:146](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L146)
...
```ts
new PromptRedactionError(args): PromptRedactionError;
```

Defined in: [packages/provider/src/errors/errors.ts:152](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L152)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `args` | \{ `fieldPath`: `string`; `patternName`: `string`; `role?`: `string`; \} |
| `args.fieldPath` | `string` |
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-cause"></a> `cause?` | `public` | `unknown` | `undefined` | - | - | [`GraphorinProviderError`](/api/@graphorin/provider/classes/GraphorinProviderError.md).[`cause`](/api/@graphorin/provider/classes/GraphorinProviderError.md#property-cause) | [node\_modules/.pnpm/typescript@5.9.3/node\_modules/typescript/lib/lib.es2022.error.d.ts:26](https://github.com/o-stepper/graphorin/blob/main/node_modules/.pnpm/typescript@5.9.3/node_modules/typescript/lib/lib.es2022.error.d.ts#L26) |
| <a id="property-fieldpath"></a> `fieldPath` | `readonly` | `string` | `undefined` | - | - | - | [packages/provider/src/errors/errors.ts:149](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L149) |
...
| <a id="property-name"></a> `name` | `readonly` | `"PromptRedactionError"` | `'PromptRedactionError'` | - | [`GraphorinProviderError`](/api/@graphorin/provider/classes/GraphorinProviderError.md).[`name`](/api/@graphorin/provider/classes/GraphorinProviderError.md#property-name) | - | [packages/provider/src/errors/errors.ts:147](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L147) |
| <a id="property-patternname"></a> `patternName` | `readonly` | `string` | `undefined` | - | - | - | [packages/provider/src/errors/errors.ts:148](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L148) |
| <a id="property-role"></a> `role?` | `readonly` | `string` | `undefined` | - | - | - | [packages/provider/src/errors/errors.ts:150](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L150) |
