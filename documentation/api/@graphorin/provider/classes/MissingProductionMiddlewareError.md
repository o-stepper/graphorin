...
[Graphorin API reference](/api/index.md) / [@graphorin/provider](/api/@graphorin/provider/index.md) / [](/api/@graphorin/provider/README.md) / MissingProductionMiddlewareError

# Class: MissingProductionMiddlewareError

Defined in: [packages/provider/src/errors/errors.ts:75](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L75)
...
```ts
new MissingProductionMiddlewareError(missing): MissingProductionMiddlewareError;
```

Defined in: [packages/provider/src/errors/errors.ts:79](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L79)
...
| <a id="property-missing"></a> `missing` | `readonly` | `string` | `undefined` | - | - | - | [packages/provider/src/errors/errors.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L77) |
| <a id="property-name"></a> `name` | `readonly` | `"MissingProductionMiddlewareError"` | `'MissingProductionMiddlewareError'` | - | [`GraphorinProviderError`](/api/@graphorin/provider/classes/GraphorinProviderError.md).[`name`](/api/@graphorin/provider/classes/GraphorinProviderError.md#property-name) | - | [packages/provider/src/errors/errors.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L76) |
