...
Defined in: packages/provider/src/errors/errors.ts:127
...
Defined in: packages/provider/src/errors/errors.ts:131
...
| <a id="property-name"></a> `name` | `readonly` | `"RateLimitExceededError"` | `'RateLimitExceededError'` | - | [`GraphorinProviderError`](/api/@graphorin/provider/classes/GraphorinProviderError.md).[`name`](/api/@graphorin/provider/classes/GraphorinProviderError.md#property-name) | - | packages/provider/src/errors/errors.ts:128 |
| <a id="property-retryafterms"></a> `retryAfterMs` | `readonly` | `number` | `undefined` | - | - | - | packages/provider/src/errors/errors.ts:129 |
