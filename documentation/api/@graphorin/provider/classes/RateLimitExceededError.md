...
[Graphorin API reference](/api/index.md) / [@graphorin/provider](/api/@graphorin/provider/index.md) / [](/api/@graphorin/provider/README.md) / RateLimitExceededError

# Class: RateLimitExceededError

Defined in: [packages/provider/src/errors/errors.ts:127](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L127)
...
Defined in: [packages/provider/src/errors/errors.ts:131](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L131)
...
| <a id="property-name"></a> `name` | `readonly` | `"RateLimitExceededError"` | `'RateLimitExceededError'` | - | [`GraphorinProviderError`](/api/@graphorin/provider/classes/GraphorinProviderError.md).[`name`](/api/@graphorin/provider/classes/GraphorinProviderError.md#property-name) | - | [packages/provider/src/errors/errors.ts:128](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L128) |
| <a id="property-retryafterms"></a> `retryAfterMs` | `readonly` | `number` | `undefined` | - | - | - | [packages/provider/src/errors/errors.ts:129](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L129) |
