...
Defined in: packages/provider/src/errors/errors.ts:329
...
Defined in: packages/provider/src/errors/errors.ts:334
...
| <a id="property-toolchoice"></a> `toolChoice` | `readonly` | `string` | `undefined` | - | - | - | packages/provider/src/errors/errors.ts:332 |
