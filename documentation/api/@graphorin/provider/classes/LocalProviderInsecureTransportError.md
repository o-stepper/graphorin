...
[Graphorin API reference](/api/index.md) / [@graphorin/provider](/api/@graphorin/provider/index.md) / [](/api/@graphorin/provider/README.md) / LocalProviderInsecureTransportError

# Class: LocalProviderInsecureTransportError

Defined in: [packages/provider/src/errors/errors.ts:175](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L175)
...
```ts
new LocalProviderInsecureTransportError(baseUrl): LocalProviderInsecureTransportError;
```

Defined in: [packages/provider/src/errors/errors.ts:179](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L179)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-baseurl"></a> `baseUrl` | `readonly` | `string` | `undefined` | - | - | - | [packages/provider/src/errors/errors.ts:177](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L177) |
...
| <a id="property-name"></a> `name` | `readonly` | `"LocalProviderInsecureTransportError"` | `'LocalProviderInsecureTransportError'` | - | [`GraphorinProviderError`](/api/@graphorin/provider/classes/GraphorinProviderError.md).[`name`](/api/@graphorin/provider/classes/GraphorinProviderError.md#property-name) | - | [packages/provider/src/errors/errors.ts:176](https://github.com/o-stepper/graphorin/blob/main/packages/provider/src/errors/errors.ts#L176) |
