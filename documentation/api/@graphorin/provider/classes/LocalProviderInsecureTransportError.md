...
Defined in: packages/provider/src/errors/errors.ts:173
...
Defined in: packages/provider/src/errors/errors.ts:177
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-baseurl"></a> `baseUrl` | `readonly` | `string` | `undefined` | - | - | - | packages/provider/src/errors/errors.ts:175 |
