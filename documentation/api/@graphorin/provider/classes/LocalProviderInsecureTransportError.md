...
Defined in: packages/provider/src/errors/errors.ts:175
...
Defined in: packages/provider/src/errors/errors.ts:179
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-baseurl"></a> `baseUrl` | `readonly` | `string` | `undefined` | - | - | - | packages/provider/src/errors/errors.ts:177 |
