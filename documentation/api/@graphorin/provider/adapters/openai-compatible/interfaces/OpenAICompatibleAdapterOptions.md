...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-acceptssensitivity"></a> `acceptsSensitivity?` | `readonly` | readonly [`Sensitivity`](/api/@graphorin/core/type-aliases/Sensitivity.md)[] | Override for the default `acceptsSensitivity` value. | packages/provider/src/adapters/openai-compatible.ts:47 |
...
| <a id="property-logger"></a> `logger?` | `readonly` | (`level`, `message`, `meta?`) => `void` | Optional log sink. | packages/provider/src/adapters/openai-compatible.ts:51 |
...
| <a id="property-name"></a> `name?` | `readonly` | `string` | Provider name attached to spans / log lines. | packages/provider/src/adapters/openai-compatible.ts:49 |
