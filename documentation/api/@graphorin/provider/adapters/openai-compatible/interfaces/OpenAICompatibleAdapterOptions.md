...
| <a id="property-timeoutms"></a> `timeoutMs?` | `readonly` | `number` | Time-to-response budget per request (PS-24). Default 120s; `0` disables. | packages/provider/src/adapters/openai-compatible.ts:58 |
