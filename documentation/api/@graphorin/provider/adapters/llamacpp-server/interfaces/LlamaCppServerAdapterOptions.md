...
| <a id="property-allowinsecuretransport"></a> `allowInsecureTransport?` | `readonly` | `boolean` | Acknowledge the risk of running over plaintext HTTP against a public host. Without this flag the adapter throws import('../errors/errors.js').LocalProviderInsecureTransportError. | packages/provider/src/adapters/llamacpp-server.ts:54 |
