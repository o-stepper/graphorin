...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-onusage"></a> `onUsage` | `readonly` | (`info`) => `void` | Pass this to [withCostTracking](/api/@graphorin/provider/variables/withCostTracking.md)'s `onUsage`. | packages/provider/src/middleware/with-cost-tracking.ts:40 |
