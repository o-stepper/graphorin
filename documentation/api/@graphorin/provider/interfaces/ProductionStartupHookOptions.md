...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-force"></a> `force?` | `readonly` | `boolean` | Force the check regardless of `NODE_ENV`. | packages/provider/src/middleware/production-hook.ts:24 |
| <a id="property-requiredkinds"></a> `requiredKinds?` | `readonly` | readonly `string`[] | Middleware kinds that must be present. Defaults to `['withRedaction']`. | packages/provider/src/middleware/production-hook.ts:22 |
