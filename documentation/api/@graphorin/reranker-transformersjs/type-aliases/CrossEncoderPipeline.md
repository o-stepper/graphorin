...
Defined in: [packages/reranker-transformersjs/src/cross-encoder.ts:39](https://github.com/o-stepper/graphorin/blob/main/packages/reranker-transformersjs/src/cross-encoder.ts#L39)
