...
| <a id="property-name"></a> `name` | `readonly` | `"CrossEncoderLoadError"` | `'CrossEncoderLoadError'` | - | `Error.name` | - | [packages/reranker-transformersjs/src/cross-encoder.ts:93](https://github.com/o-stepper/graphorin/blob/main/packages/reranker-transformersjs/src/cross-encoder.ts#L93) |
