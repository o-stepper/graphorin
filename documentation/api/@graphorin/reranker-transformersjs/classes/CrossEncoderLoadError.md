...
Defined in: [packages/reranker-transformersjs/src/cross-encoder.ts:62](https://github.com/o-stepper/graphorin/blob/main/packages/reranker-transformersjs/src/cross-encoder.ts#L62)
...
| <a id="property-name"></a> `name` | `readonly` | `"CrossEncoderLoadError"` | `'CrossEncoderLoadError'` | - | `Error.name` | - | [packages/reranker-transformersjs/src/cross-encoder.ts:63](https://github.com/o-stepper/graphorin/blob/main/packages/reranker-transformersjs/src/cross-encoder.ts#L63) |
