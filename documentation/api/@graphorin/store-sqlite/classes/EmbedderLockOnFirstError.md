...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderLockOnFirstError"` | `'EmbedderLockOnFirstError'` | - | `Error.name` | - | [packages/store-sqlite/src/embedding-meta-repo.ts:49](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L49) |
