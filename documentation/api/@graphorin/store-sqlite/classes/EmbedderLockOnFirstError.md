...
[Graphorin API reference](/api/index.md) / [@graphorin/store-sqlite](/api/@graphorin/store-sqlite/index.md) / [](/api/@graphorin/store-sqlite/README.md) / EmbedderLockOnFirstError

# Class: EmbedderLockOnFirstError
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderLockOnFirstError"` | `'EmbedderLockOnFirstError'` | - | `Error.name` | - | packages/store-sqlite/src/embedding-meta-repo.ts:49 |
