...
Defined in: [packages/store-sqlite/src/embedding-meta-repo.ts:38](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L38)
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderLockOnFirstError"` | `'EmbedderLockOnFirstError'` | - | `Error.name` | - | [packages/store-sqlite/src/embedding-meta-repo.ts:39](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L39) |
