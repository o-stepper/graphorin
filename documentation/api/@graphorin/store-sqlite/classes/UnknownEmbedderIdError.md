...
Defined in: [packages/store-sqlite/src/embedding-meta-repo.ts:48](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L48)
...
Defined in: [packages/store-sqlite/src/embedding-meta-repo.ts:50](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L50)
...
| <a id="property-id"></a> `id` | `readonly` | `string` | `undefined` | - | - | - | [packages/store-sqlite/src/embedding-meta-repo.ts:50](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L50) |
...
| <a id="property-name"></a> `name` | `readonly` | `"UnknownEmbedderIdError"` | `'UnknownEmbedderIdError'` | - | `Error.name` | - | [packages/store-sqlite/src/embedding-meta-repo.ts:49](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L49) |
