...
Defined in: [packages/store-sqlite/src/embedding-meta-repo.ts:58](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L58)
...
Defined in: [packages/store-sqlite/src/embedding-meta-repo.ts:60](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L60)
...
| <a id="property-id"></a> `id` | `readonly` | `string` | `undefined` | - | - | - | [packages/store-sqlite/src/embedding-meta-repo.ts:60](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L60) |
...
| <a id="property-name"></a> `name` | `readonly` | `"UnknownEmbedderIdError"` | `'UnknownEmbedderIdError'` | - | `Error.name` | - | [packages/store-sqlite/src/embedding-meta-repo.ts:59](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L59) |
