...
Defined in: [packages/store-sqlite/src/connection.ts:447](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L447)
...
| <a id="property-name"></a> `name` | `readonly` | `"SqliteVecMissingError"` | `'SqliteVecMissingError'` | - | `Error.name` | - | [packages/store-sqlite/src/connection.ts:448](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L448) |
