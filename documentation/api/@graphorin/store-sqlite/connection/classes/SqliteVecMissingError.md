...
Defined in: [packages/store-sqlite/src/connection.ts:435](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L435)
...
| <a id="property-name"></a> `name` | `readonly` | `"SqliteVecMissingError"` | `'SqliteVecMissingError'` | - | `Error.name` | - | [packages/store-sqlite/src/connection.ts:436](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L436) |
