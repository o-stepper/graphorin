...
Defined in: [packages/store-sqlite/src/connection.ts:462](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L462)
...
Defined in: [packages/store-sqlite/src/connection.ts:468](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L468)
...
| <a id="property-code"></a> `code` | `readonly` | `"SQLITE_BUSY"` | `'SQLITE_BUSY'` | Stable machine discriminator, mirroring the driver's code. | - | - | [packages/store-sqlite/src/connection.ts:465](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L465) |
| <a id="property-kind"></a> `kind` | `readonly` | `"sqlite-busy"` | `'sqlite-busy'` | Package-level error kind, matching the repo's `kind` convention. | - | - | [packages/store-sqlite/src/connection.ts:467](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L467) |
...
| <a id="property-name"></a> `name` | `readonly` | `"SqliteBusyError"` | `'SqliteBusyError'` | - | `Error.name` | - | [packages/store-sqlite/src/connection.ts:463](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L463) |
