...
Defined in: [packages/store-sqlite/src/connection.ts:450](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L450)
...
Defined in: [packages/store-sqlite/src/connection.ts:456](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L456)
...
| <a id="property-code"></a> `code` | `readonly` | `"SQLITE_BUSY"` | `'SQLITE_BUSY'` | Stable machine discriminator, mirroring the driver's code. | - | - | [packages/store-sqlite/src/connection.ts:453](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L453) |
| <a id="property-kind"></a> `kind` | `readonly` | `"sqlite-busy"` | `'sqlite-busy'` | Package-level error kind, matching the repo's `kind` convention. | - | - | [packages/store-sqlite/src/connection.ts:455](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L455) |
...
| <a id="property-name"></a> `name` | `readonly` | `"SqliteBusyError"` | `'SqliteBusyError'` | - | `Error.name` | - | [packages/store-sqlite/src/connection.ts:451](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L451) |
