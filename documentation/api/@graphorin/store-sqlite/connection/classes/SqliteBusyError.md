...
Defined in: [packages/store-sqlite/src/connection.ts:412](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L412)
...
Defined in: [packages/store-sqlite/src/connection.ts:418](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L418)
...
| <a id="property-code"></a> `code` | `readonly` | `"SQLITE_BUSY"` | `'SQLITE_BUSY'` | Stable machine discriminator, mirroring the driver's code. | - | - | [packages/store-sqlite/src/connection.ts:415](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L415) |
| <a id="property-kind"></a> `kind` | `readonly` | `"sqlite-busy"` | `'sqlite-busy'` | Package-level error kind, matching the repo's `kind` convention. | - | - | [packages/store-sqlite/src/connection.ts:417](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L417) |
...
| <a id="property-name"></a> `name` | `readonly` | `"SqliteBusyError"` | `'SqliteBusyError'` | - | `Error.name` | - | [packages/store-sqlite/src/connection.ts:413](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/connection.ts#L413) |
