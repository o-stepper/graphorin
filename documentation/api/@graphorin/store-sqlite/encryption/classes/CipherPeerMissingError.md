...
Defined in: packages/store-sqlite/src/encryption/index.ts:66
...
Defined in: packages/store-sqlite/src/encryption/index.ts:68
...
| <a id="property-name"></a> `name` | `readonly` | `"CipherPeerMissingError"` | `'CipherPeerMissingError'` | - | `Error.name` | - | packages/store-sqlite/src/encryption/index.ts:67 |
