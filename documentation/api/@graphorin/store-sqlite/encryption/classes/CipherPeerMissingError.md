...
Defined in: [packages/store-sqlite/src/encryption/index.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/encryption/index.ts#L94)
...
| <a id="property-name"></a> `name` | `readonly` | `"CipherPeerMissingError"` | `'CipherPeerMissingError'` | - | `Error.name` | - | [packages/store-sqlite/src/encryption/index.ts:95](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/encryption/index.ts#L95) |
