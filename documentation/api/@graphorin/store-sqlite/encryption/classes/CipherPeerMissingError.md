...
Defined in: packages/store-sqlite/src/encryption/index.ts:94
...
| <a id="property-name"></a> `name` | `readonly` | `"CipherPeerMissingError"` | `'CipherPeerMissingError'` | - | `Error.name` | - | packages/store-sqlite/src/encryption/index.ts:95 |
