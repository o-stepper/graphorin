...
| `encryption.cipher?` | `readonly` | [`EncryptionCipher`](/api/@graphorin/store-sqlite/encryption/type-aliases/EncryptionCipher.md) | - | [packages/store-sqlite/src/encryption/index.ts:65](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/encryption/index.ts#L65) |
| `encryption.enabled` | `readonly` | `true` | - | [packages/store-sqlite/src/encryption/index.ts:64](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/encryption/index.ts#L64) |
