...
Defined in: packages/store-sqlite/src/audit-db.ts:19
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | packages/store-sqlite/src/audit-db.ts:20 |
