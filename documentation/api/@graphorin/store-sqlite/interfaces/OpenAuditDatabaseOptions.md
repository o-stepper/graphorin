...
| <a id="property-driver"></a> `driver?` | `readonly` | [`BetterSqlite3Constructor`](/api/@graphorin/store-sqlite/connection/type-aliases/BetterSqlite3Constructor.md) | Optional driver override for tests. | packages/store-sqlite/src/audit-db.ts:19 |
