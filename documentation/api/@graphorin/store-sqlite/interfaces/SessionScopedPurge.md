...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-fts"></a> `fts?` | `readonly` | `string` | FTS5 shadow table joined by rowid, when the table has one. | packages/store-sqlite/src/session-store.ts:409 |
| <a id="property-history"></a> `history?` | `readonly` | \{ `kind`: `string`; `textColumn`: `string`; `valueMatch`: `boolean`; \} | Scrub `memory_history` values for the deleted rows (store-04 parity). `valueMatch` additionally clears history rows whose values equal the deleted row's text (the SUPERSEDE shape). | packages/store-sqlite/src/session-store.ts:419 |
...
| <a id="property-refs"></a> `refs?` | `readonly` | readonly \{ `column`: `string`; `table`: `string`; \}[] | Tables referencing the base rows - cleared BEFORE the base rows. | packages/store-sqlite/src/session-store.ts:413 |
| <a id="property-sessioncolumn"></a> `sessionColumn` | `readonly` | `"scope_session_id"` \| `"session_id"` | Column carrying the session id. | packages/store-sqlite/src/session-store.ts:407 |
| <a id="property-table"></a> `table` | `readonly` | `string` | Base table holding the session-scoped rows. | packages/store-sqlite/src/session-store.ts:405 |
| <a id="property-vec"></a> `vec?` | `readonly` | \{ `idColumn`: `string`; `prefix`: `string`; \} | Per-embedder vec0 sidecar family (name prefix + id column). | packages/store-sqlite/src/session-store.ts:411 |
