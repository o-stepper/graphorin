...
| <a id="property-phase"></a> `phase?` | `readonly` | `"light"` \| `"standard"` \| `"deep"` \| `null` | Phase that failed (MCON-10); `null` ⇒ legacy row. | packages/store-sqlite/src/consolidator-store.ts:107 |
