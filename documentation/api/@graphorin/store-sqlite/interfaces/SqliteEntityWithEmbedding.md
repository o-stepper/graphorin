...
[Graphorin API reference](/api/index.md) / [@graphorin/store-sqlite](/api/@graphorin/store-sqlite/index.md) / [](/api/@graphorin/store-sqlite/README.md) / SqliteEntityWithEmbedding
...
| <a id="property-embedderid"></a> `embedderId` | `readonly` | `string` \| `null` | - | - | packages/store-sqlite/src/memory-store.ts:2174 |
...
| <a id="property-vector"></a> `vector` | `readonly` | `Float32Array`\&lt;`ArrayBufferLike`\&gt; \| `null` | - | - | packages/store-sqlite/src/memory-store.ts:2173 |
