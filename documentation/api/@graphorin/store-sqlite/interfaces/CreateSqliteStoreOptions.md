...
| <a id="property-driver"></a> `driver?` | `readonly` | [`BetterSqlite3Constructor`](/api/@graphorin/store-sqlite/connection/type-aliases/BetterSqlite3Constructor.md) | Override constructor — test-only escape hatch. | packages/store-sqlite/src/index.ts:133 |
