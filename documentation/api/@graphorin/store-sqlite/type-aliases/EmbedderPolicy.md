...
Defined in: [packages/store-sqlite/src/embedding-meta-repo.ts:77](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/embedding-meta-repo.ts#L77)
