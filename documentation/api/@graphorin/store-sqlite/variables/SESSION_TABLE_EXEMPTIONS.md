...
Defined in: [packages/store-sqlite/src/session-store.ts:522](https://github.com/o-stepper/graphorin/blob/main/packages/store-sqlite/src/session-store.ts#L522)
