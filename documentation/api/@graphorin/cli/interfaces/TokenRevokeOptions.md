...
Defined in: [packages/cli/src/commands/token.ts:173](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L173)
...
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:174](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L174) |
