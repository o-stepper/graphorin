...
Defined in: packages/cli/src/commands/memory.ts:590
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | Cap on the most-recent recall spans returned. Default 5. | - | packages/cli/src/commands/memory.ts:594 |
...
| <a id="property-sessionid"></a> `sessionId?` | `readonly` | `string` | Restrict to one session's recall spans. | - | packages/cli/src/commands/memory.ts:592 |
