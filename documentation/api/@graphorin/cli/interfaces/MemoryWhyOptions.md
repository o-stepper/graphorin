...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / MemoryWhyOptions

# Interface: MemoryWhyOptions

Defined in: [packages/cli/src/commands/memory.ts:590](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L590)
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | Cap on the most-recent recall spans returned. Default 5. | - | [packages/cli/src/commands/memory.ts:594](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L594) |
...
| <a id="property-sessionid"></a> `sessionId?` | `readonly` | `string` | Restrict to one session's recall spans. | - | [packages/cli/src/commands/memory.ts:592](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L592) |
