...
Defined in: [packages/cli/src/commands/memory.ts:389](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L389)
...
| <a id="property-factid"></a> `factId` | `readonly` | `string` | - | - | [packages/cli/src/commands/memory.ts:390](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L390) |
