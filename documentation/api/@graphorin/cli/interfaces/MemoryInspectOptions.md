...
| <a id="property-factid"></a> `factId` | `readonly` | `string` | - | - | [packages/cli/src/commands/memory.ts:378](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L378) |
