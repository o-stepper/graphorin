...
Defined in: [packages/cli/src/commands/token.ts:292](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L292)
...
| <a id="property-prefix"></a> `prefix?` | `readonly` | `string` | Optional override of the expected token prefix. | - | [packages/cli/src/commands/token.ts:295](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L295) |
...
| <a id="property-token"></a> `token` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:293](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L293) |
