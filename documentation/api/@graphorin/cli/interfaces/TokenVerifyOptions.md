...
Defined in: packages/cli/src/commands/token.ts:319
...
| <a id="property-prefix"></a> `prefix?` | `readonly` | `string` | Optional override of the expected token prefix. | - | packages/cli/src/commands/token.ts:322 |
...
| <a id="property-token"></a> `token` | `readonly` | `string` | - | - | packages/cli/src/commands/token.ts:320 |
