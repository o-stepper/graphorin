...
Defined in: [packages/cli/src/commands/token.ts:301](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L301)
...
| <a id="property-prefix"></a> `prefix?` | `readonly` | `string` | Optional override of the expected token prefix. | - | [packages/cli/src/commands/token.ts:304](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L304) |
...
| <a id="property-token"></a> `token` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:302](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L302) |
