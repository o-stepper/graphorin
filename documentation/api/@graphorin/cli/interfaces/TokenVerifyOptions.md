...
Defined in: [packages/cli/src/commands/token.ts:319](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L319)
...
| <a id="property-prefix"></a> `prefix?` | `readonly` | `string` | Optional override of the expected token prefix. | - | [packages/cli/src/commands/token.ts:322](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L322) |
...
| <a id="property-token"></a> `token` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:320](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L320) |
