...
Defined in: packages/cli/src/commands/workflow.ts:39
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-config"></a> `config?` | `readonly` | `string` | - | - | packages/cli/src/commands/workflow.ts:40 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/cli/src/commands/workflow.ts:43 |
| <a id="property-workflow"></a> `workflow` | `readonly` | `string` | Workflow NAME the thread belongs to (derives the checkpoint namespace). | - | packages/cli/src/commands/workflow.ts:42 |
