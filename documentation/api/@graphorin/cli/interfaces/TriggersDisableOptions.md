...
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | [packages/cli/src/commands/triggers.ts:152](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/triggers.ts#L152) |
