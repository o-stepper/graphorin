...
Defined in: [packages/cli/src/commands/pricing.ts:194](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/pricing.ts#L194)
...
| <a id="property-spans"></a> `spans` | `readonly` | `string` | Path to a JSON file containing an array of trace spans (each with an `attributes` map). Output of `graphorin traces export` (Phase 15) is the canonical source. | - | [packages/cli/src/commands/pricing.ts:200](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/pricing.ts#L200) |
