...
Defined in: [packages/cli/src/commands/memory.ts:112](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L112)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-config"></a> `config?` | `readonly` | `string` | - | [`MemoryCommonOptions`](/api/@graphorin/cli/interfaces/MemoryCommonOptions.md).[`config`](/api/@graphorin/cli/interfaces/MemoryCommonOptions.md#property-config) | [packages/cli/src/commands/memory.ts:35](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L35) |
| <a id="property-embeddersmodule"></a> `embeddersModule?` | `readonly` | `string` | Optional path to a JS / TS module exporting an `embedders` object: `{ <id>: () => EmbedderProvider }`. The CLI imports this module so it can construct the source / target embedder instances the runner needs. Without the module the command exits `2` with a pointer to the documentation. | - | [packages/cli/src/commands/memory.ts:123](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L123) |
| <a id="property-from"></a> `from` | `readonly` | `string` | - | - | [packages/cli/src/commands/memory.ts:113](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L113) |
...
| <a id="property-strategy"></a> `strategy` | `readonly` | `"lock-on-first"` \| `"auto-migrate"` \| `"multi-active"` | - | - | [packages/cli/src/commands/memory.ts:115](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L115) |
| <a id="property-to"></a> `to` | `readonly` | `string` | - | - | [packages/cli/src/commands/memory.ts:114](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L114) |
