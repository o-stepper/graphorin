...
Defined in: packages/cli/src/commands/memory.ts:112
...
| <a id="property-from"></a> `from` | `readonly` | `string` | - | - | packages/cli/src/commands/memory.ts:113 |
...
| <a id="property-strategy"></a> `strategy` | `readonly` | `"lock-on-first"` \| `"auto-migrate"` \| `"multi-active"` | - | - | packages/cli/src/commands/memory.ts:115 |
| <a id="property-to"></a> `to` | `readonly` | `string` | - | - | packages/cli/src/commands/memory.ts:114 |
