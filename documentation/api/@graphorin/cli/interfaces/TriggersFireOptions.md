...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / TriggersFireOptions
...
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | packages/cli/src/commands/triggers.ts:112 |
