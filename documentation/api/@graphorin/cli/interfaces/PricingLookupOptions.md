...
Defined in: packages/cli/src/commands/pricing.ts:164
...
| <a id="property-model"></a> `model` | `readonly` | `string` | - | - | packages/cli/src/commands/pricing.ts:166 |
...
| <a id="property-provider"></a> `provider` | `readonly` | `string` | - | - | packages/cli/src/commands/pricing.ts:165 |
| <a id="property-region"></a> `region?` | `readonly` | `string` | - | - | packages/cli/src/commands/pricing.ts:167 |
