...
Defined in: packages/cli/src/commands/pricing.ts:146
...
| <a id="property-model"></a> `model` | `readonly` | `string` | - | - | packages/cli/src/commands/pricing.ts:148 |
...
| <a id="property-provider"></a> `provider` | `readonly` | `string` | - | - | packages/cli/src/commands/pricing.ts:147 |
| <a id="property-region"></a> `region?` | `readonly` | `string` | - | - | packages/cli/src/commands/pricing.ts:149 |
