...
Defined in: [packages/cli/src/commands/pricing.ts:163](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/pricing.ts#L163)
...
| <a id="property-model"></a> `model` | `readonly` | `string` | - | - | [packages/cli/src/commands/pricing.ts:165](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/pricing.ts#L165) |
...
| <a id="property-provider"></a> `provider` | `readonly` | `string` | - | - | [packages/cli/src/commands/pricing.ts:164](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/pricing.ts#L164) |
| <a id="property-region"></a> `region?` | `readonly` | `string` | - | - | [packages/cli/src/commands/pricing.ts:166](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/pricing.ts#L166) |
