...
Defined in: [packages/cli/src/commands/consolidator.ts:129](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/consolidator.ts#L129)
...
| <a id="property-tier"></a> `tier` | `readonly` | [`ConsolidatorTier`](/api/@graphorin/memory/type-aliases/ConsolidatorTier.md) | - | - | [packages/cli/src/commands/consolidator.ts:130](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/consolidator.ts#L130) |
