...
Defined in: [packages/cli/src/commands/token.ts:267](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L267)
...
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | [packages/cli/src/commands/token.ts:268](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L268) |
