...
Defined in: packages/cli/src/commands/pricing.ts:117
...
| <a id="property-snapshot"></a> `snapshot` | `readonly` | `string` | Path to a JSON file containing a `PricingSnapshot`. The CLI diffs this against the bundled snapshot. | - | packages/cli/src/commands/pricing.ts:122 |
