...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / SecretsListOptions

# Interface: SecretsListOptions

Defined in: [packages/cli/src/commands/secrets.ts:55](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L55)
