...
Defined in: [packages/cli/src/commands/token.ts:135](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L135)
...
| <a id="property-includerevoked"></a> `includeRevoked?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/token.ts:136](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L136) |
