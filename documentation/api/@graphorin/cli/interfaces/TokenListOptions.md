...
| <a id="property-includerevoked"></a> `includeRevoked?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/token.ts:132](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L132) |
