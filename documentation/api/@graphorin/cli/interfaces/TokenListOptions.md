...
Defined in: [packages/cli/src/commands/token.ts:122](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L122)
...
| <a id="property-includerevoked"></a> `includeRevoked?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/token.ts:123](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L123) |
