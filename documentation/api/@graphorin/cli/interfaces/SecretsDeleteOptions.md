...
Defined in: [packages/cli/src/commands/secrets.ts:160](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L160)
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:161](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L161) |
