...
Defined in: [packages/cli/src/commands/traces.ts:32](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/traces.ts#L32)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-config"></a> `config?` | `readonly` | `string` | - | - | [packages/cli/src/commands/traces.ts:33](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/traces.ts#L33) |
