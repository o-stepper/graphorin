...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / ConsolidatorStopOptions

# Interface: ConsolidatorStopOptions

Defined in: [packages/cli/src/commands/consolidator.ts:170](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/consolidator.ts#L170)
