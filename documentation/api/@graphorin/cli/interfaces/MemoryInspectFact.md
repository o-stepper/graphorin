...
| <a id="property-supersedes"></a> `supersedes` | `readonly` | `string` \| `null` | - | packages/cli/src/commands/memory.ts:332 |
| <a id="property-text"></a> `text` | `readonly` | `string` | - | packages/cli/src/commands/memory.ts:325 |
| <a id="property-validfrom"></a> `validFrom` | `readonly` | `string` \| `null` | - | packages/cli/src/commands/memory.ts:330 |
| <a id="property-validto"></a> `validTo` | `readonly` | `string` \| `null` | - | packages/cli/src/commands/memory.ts:331 |
