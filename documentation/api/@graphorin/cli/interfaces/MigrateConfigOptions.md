...
Defined in: [packages/cli/src/commands/migrate-config.ts:33](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-config.ts#L33)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-input"></a> `input` | `readonly` | `string` | - | - | [packages/cli/src/commands/migrate-config.ts:34](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-config.ts#L34) |
...
| <a id="property-out"></a> `out?` | `readonly` | `string` | - | - | [packages/cli/src/commands/migrate-config.ts:35](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-config.ts#L35) |
