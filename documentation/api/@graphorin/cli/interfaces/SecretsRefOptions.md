...
| <a id="property-reveal"></a> `reveal?` | `readonly` | `boolean` | - | - | packages/cli/src/commands/secrets.ts:179 |
| <a id="property-uri"></a> `uri` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:178 |
