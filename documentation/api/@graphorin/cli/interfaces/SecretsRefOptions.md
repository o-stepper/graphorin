...
Defined in: packages/cli/src/commands/secrets.ts:195
...
| <a id="property-reveal"></a> `reveal?` | `readonly` | `boolean` | - | - | packages/cli/src/commands/secrets.ts:197 |
...
| <a id="property-uri"></a> `uri` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:196 |
