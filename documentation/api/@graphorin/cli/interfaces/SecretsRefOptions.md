...
Defined in: [packages/cli/src/commands/secrets.ts:192](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L192)
...
| <a id="property-reveal"></a> `reveal?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/secrets.ts:194](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L194) |
...
| <a id="property-uri"></a> `uri` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:193](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L193) |
