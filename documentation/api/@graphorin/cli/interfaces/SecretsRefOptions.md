...
Defined in: packages/cli/src/commands/secrets.ts:192
...
| <a id="property-reveal"></a> `reveal?` | `readonly` | `boolean` | - | - | packages/cli/src/commands/secrets.ts:194 |
...
| <a id="property-uri"></a> `uri` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:193 |
