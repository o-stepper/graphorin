...
Defined in: [packages/cli/src/commands/secrets.ts:180](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L180)
...
| <a id="property-reveal"></a> `reveal?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/secrets.ts:182](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L182) |
| <a id="property-uri"></a> `uri` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:181](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L181) |
