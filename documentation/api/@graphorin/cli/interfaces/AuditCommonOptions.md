...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / AuditCommonOptions

# Interface: AuditCommonOptions

Defined in: [packages/cli/src/commands/audit.ts:55](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/audit.ts#L55)
...
- [`AuditExportOptions`](/api/@graphorin/cli/interfaces/AuditExportOptions.md)
- [`AuditPruneOptions`](/api/@graphorin/cli/interfaces/AuditPruneOptions.md)

## Properties

| Property | Modifier | Type | Description | Inherited from | Defined in |
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-config"></a> `config?` | `readonly` | `string` | - | - | [packages/cli/src/commands/audit.ts:56](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/audit.ts#L56) |
