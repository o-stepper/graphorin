...
Defined in: packages/cli/src/commands/token.ts:53
...
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | packages/cli/src/commands/token.ts:59 |
| <a id="property-expiresin"></a> `expiresIn?` | `readonly` | `string` | Duration string: `30d`, `12h`, `90m`, `45s`. | - | packages/cli/src/commands/token.ts:58 |
...
| <a id="property-label"></a> `label?` | `readonly` | `string` | - | - | packages/cli/src/commands/token.ts:54 |
...
| <a id="property-scopes"></a> `scopes` | `readonly` | readonly `string`[] | Comma-separated scope list. | - | packages/cli/src/commands/token.ts:56 |
