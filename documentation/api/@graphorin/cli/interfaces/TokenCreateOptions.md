...
Defined in: [packages/cli/src/commands/token.ts:53](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L53)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-config"></a> `config?` | `readonly` | `string` | - | [`TokenCommonOptions`](/api/@graphorin/cli/interfaces/TokenCommonOptions.md).[`config`](/api/@graphorin/cli/interfaces/TokenCommonOptions.md#property-config) | [packages/cli/src/commands/token.ts:49](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L49) |
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | [packages/cli/src/commands/token.ts:59](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L59) |
| <a id="property-expiresin"></a> `expiresIn?` | `readonly` | `string` | Duration string: `30d`, `12h`, `90m`, `45s`. | - | [packages/cli/src/commands/token.ts:58](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L58) |
...
| <a id="property-label"></a> `label?` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:54](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L54) |
...
| <a id="property-scopes"></a> `scopes` | `readonly` | readonly `string`[] | Comma-separated scope list. | - | [packages/cli/src/commands/token.ts:56](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L56) |
