...
Defined in: [packages/cli/src/commands/storage.ts:133](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L133)
...
| <a id="property-dest"></a> `dest` | `readonly` | `string` | Destination file path for the backup copy. | - | [packages/cli/src/commands/storage.ts:135](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L135) |
...
| <a id="property-overwrite"></a> `overwrite?` | `readonly` | `boolean` | Replace an existing destination file. Default: refuse. | - | [packages/cli/src/commands/storage.ts:137](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L137) |
