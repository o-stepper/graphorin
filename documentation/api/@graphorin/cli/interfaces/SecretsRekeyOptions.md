...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / SecretsRekeyOptions

# Interface: SecretsRekeyOptions

Defined in: packages/cli/src/commands/secrets.ts:307
...
| <a id="property-newpassphrasefrom"></a> `newPassphraseFrom` | `readonly` | `string` | SecretRef URI resolving to the NEW bundle passphrase. | - | packages/cli/src/commands/secrets.ts:309 |
