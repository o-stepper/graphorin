...
Defined in: [packages/cli/src/commands/auth.ts:57](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/auth.ts#L57)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-config"></a> `config?` | `readonly` | `string` | - | - | [packages/cli/src/commands/auth.ts:58](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/auth.ts#L58) |
