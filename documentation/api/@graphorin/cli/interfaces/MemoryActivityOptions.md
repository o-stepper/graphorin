...
Defined in: [packages/cli/src/commands/memory.ts:457](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L457)
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | Cap on the recent-history / recent-conflict rows returned. Default 20. | - | [packages/cli/src/commands/memory.ts:459](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L459) |
