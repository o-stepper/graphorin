...
Defined in: packages/cli/src/commands/memory.ts:587
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | Cap on the recent-history / recent-conflict rows returned. Default 20. | - | packages/cli/src/commands/memory.ts:589 |
