...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / TriggersPruneOptions

# Interface: TriggersPruneOptions

Defined in: packages/cli/src/commands/triggers.ts:187
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-before"></a> `before?` | `readonly` | `string` | ISO date / epoch ms - drop disabled triggers whose `lastFiredAt` (or `createdAt`, when never fired) is older than this cutoff. | - | packages/cli/src/commands/triggers.ts:192 |
