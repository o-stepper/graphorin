...
Defined in: [packages/cli/src/commands/triggers.ts:179](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/triggers.ts#L179)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-before"></a> `before?` | `readonly` | `string` | ISO date / epoch ms - drop disabled triggers whose `lastFiredAt` (or `createdAt`, when never fired) is older than this cutoff. | - | [packages/cli/src/commands/triggers.ts:184](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/triggers.ts#L184) |
