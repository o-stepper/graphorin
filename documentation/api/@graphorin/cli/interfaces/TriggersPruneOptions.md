...
Defined in: [packages/cli/src/commands/triggers.ts:187](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/triggers.ts#L187)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-before"></a> `before?` | `readonly` | `string` | ISO date / epoch ms - drop disabled triggers whose `lastFiredAt` (or `createdAt`, when never fired) is older than this cutoff. | - | [packages/cli/src/commands/triggers.ts:192](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/triggers.ts#L192) |
