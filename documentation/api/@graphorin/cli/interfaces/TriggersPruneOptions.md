...
Defined in: packages/cli/src/commands/triggers.ts:175
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-before"></a> `before?` | `readonly` | `string` | ISO date / epoch ms — drop disabled triggers whose `lastFiredAt` (or `createdAt`, when never fired) is older than this cutoff. | - | packages/cli/src/commands/triggers.ts:180 |
