...
Defined in: [packages/cli/src/commands/memory.ts:841](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L841)
...
| <a id="property-force"></a> `force?` | `readonly` | `boolean` | Override the injection-refusal gate (operator action, after review). | - | [packages/cli/src/commands/memory.ts:849](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L849) |
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | Cap on the rows listed per type. Default 20. | - | [packages/cli/src/commands/memory.ts:843](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L843) |
...
| <a id="property-promote"></a> `promote?` | `readonly` | `string` | Promote this id out of quarantine instead of listing. | - | [packages/cli/src/commands/memory.ts:845](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L845) |
| <a id="property-reason"></a> `reason?` | `readonly` | `string` | Audit reason recorded with the promotion. | - | [packages/cli/src/commands/memory.ts:847](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L847) |
