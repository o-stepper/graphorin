...
Defined in: [packages/cli/src/commands/memory.ts:701](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L701)
...
| <a id="property-force"></a> `force?` | `readonly` | `boolean` | Override the injection-refusal gate (operator action, after review). | - | [packages/cli/src/commands/memory.ts:709](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L709) |
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | Cap on the rows listed per type. Default 20. | - | [packages/cli/src/commands/memory.ts:703](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L703) |
...
| <a id="property-promote"></a> `promote?` | `readonly` | `string` | Promote this id out of quarantine instead of listing. | - | [packages/cli/src/commands/memory.ts:705](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L705) |
| <a id="property-reason"></a> `reason?` | `readonly` | `string` | Audit reason recorded with the promotion. | - | [packages/cli/src/commands/memory.ts:707](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/memory.ts#L707) |
