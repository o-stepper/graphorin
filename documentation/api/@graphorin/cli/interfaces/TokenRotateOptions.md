...
Defined in: packages/cli/src/commands/token.ts:211
...
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | packages/cli/src/commands/token.ts:213 |
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | packages/cli/src/commands/token.ts:212 |
