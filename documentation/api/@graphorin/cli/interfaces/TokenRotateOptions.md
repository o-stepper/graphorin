...
Defined in: packages/cli/src/commands/token.ts:193
...
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | packages/cli/src/commands/token.ts:195 |
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | packages/cli/src/commands/token.ts:194 |
