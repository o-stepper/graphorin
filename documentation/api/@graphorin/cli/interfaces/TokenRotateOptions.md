...
Defined in: [packages/cli/src/commands/token.ts:203](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L203)
...
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | [packages/cli/src/commands/token.ts:205](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L205) |
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:204](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L204) |
