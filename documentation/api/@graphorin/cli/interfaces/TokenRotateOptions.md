...
Defined in: [packages/cli/src/commands/token.ts:211](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L211)
...
| <a id="property-env"></a> `env?` | `readonly` | `"live"` \| `"test"` | - | - | [packages/cli/src/commands/token.ts:213](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L213) |
| <a id="property-id"></a> `id` | `readonly` | `string` | - | - | [packages/cli/src/commands/token.ts:212](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/token.ts#L212) |
