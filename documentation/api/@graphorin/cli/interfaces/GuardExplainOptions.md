...
| <a id="property-print"></a> `print?` | `readonly` | `PrintSink` | Test seam - capture human lines instead of writing to stderr. | [`GuardCommonOptions`](/api/@graphorin/cli/interfaces/GuardCommonOptions.md).[`print`](/api/@graphorin/cli/interfaces/GuardCommonOptions.md#property-print) | packages/cli/src/internal/output.ts:75 |
