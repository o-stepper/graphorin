...
Defined in: packages/cli/src/commands/storage.ts:471
...
| <a id="property-newpassphrasefrom"></a> `newPassphraseFrom` | `readonly` | `string` | - | - | packages/cli/src/commands/storage.ts:473 |
...
| <a id="property-oldpassphrasefrom"></a> `oldPassphraseFrom` | `readonly` | `string` | - | - | packages/cli/src/commands/storage.ts:472 |
