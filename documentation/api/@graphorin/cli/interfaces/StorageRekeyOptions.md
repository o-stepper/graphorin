...
Defined in: packages/cli/src/commands/storage.ts:402
...
| <a id="property-newpassphrasefrom"></a> `newPassphraseFrom` | `readonly` | `string` | - | - | packages/cli/src/commands/storage.ts:404 |
...
| <a id="property-oldpassphrasefrom"></a> `oldPassphraseFrom` | `readonly` | `string` | - | - | packages/cli/src/commands/storage.ts:403 |
