...
Defined in: packages/cli/src/commands/storage.ts:214
...
| <a id="property-newpassphrasefrom"></a> `newPassphraseFrom` | `readonly` | `string` | - | - | packages/cli/src/commands/storage.ts:216 |
...
| <a id="property-oldpassphrasefrom"></a> `oldPassphraseFrom` | `readonly` | `string` | - | - | packages/cli/src/commands/storage.ts:215 |
