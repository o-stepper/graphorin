...
Defined in: [packages/cli/src/commands/storage.ts:397](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L397)
...
| <a id="property-newpassphrasefrom"></a> `newPassphraseFrom` | `readonly` | `string` | - | - | [packages/cli/src/commands/storage.ts:399](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L399) |
...
| <a id="property-oldpassphrasefrom"></a> `oldPassphraseFrom` | `readonly` | `string` | - | - | [packages/cli/src/commands/storage.ts:398](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L398) |
