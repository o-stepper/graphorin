...
Defined in: [packages/cli/src/commands/storage.ts:402](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L402)
...
| <a id="property-newpassphrasefrom"></a> `newPassphraseFrom` | `readonly` | `string` | - | - | [packages/cli/src/commands/storage.ts:404](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L404) |
...
| <a id="property-oldpassphrasefrom"></a> `oldPassphraseFrom` | `readonly` | `string` | - | - | [packages/cli/src/commands/storage.ts:403](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/storage.ts#L403) |
