...
Defined in: [packages/cli/src/commands/consolidator.ts:217](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/consolidator.ts#L217)
...
| <a id="property-limit"></a> `limit?` | `readonly` | `number` | - | - | [packages/cli/src/commands/consolidator.ts:220](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/consolidator.ts#L220) |
...
| <a id="property-user"></a> `user?` | `readonly` | `string` | Narrow to one user's batches (`scope_user_id`). | - | [packages/cli/src/commands/consolidator.ts:219](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/consolidator.ts#L219) |
