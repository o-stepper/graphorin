...
| <a id="property-writer"></a> `writer?` | `readonly` | `string` | Surfaced on the meta header. Defaults to `'graphorin-cli@0.1.0'`. | - | packages/cli/src/commands/migrate-export.ts:47 |
