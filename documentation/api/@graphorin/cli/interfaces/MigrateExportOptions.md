...
Defined in: [packages/cli/src/commands/migrate-export.ts:42](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-export.ts#L42)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-input"></a> `input` | `readonly` | `string` | - | - | [packages/cli/src/commands/migrate-export.ts:43](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-export.ts#L43) |
...
| <a id="property-to"></a> `to` | `readonly` | `string` | - | - | [packages/cli/src/commands/migrate-export.ts:44](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-export.ts#L44) |
| <a id="property-toschema"></a> `toSchema?` | `readonly` | `string` | Defaults to the writer's current schema (e.g. `'1.0'`). | - | [packages/cli/src/commands/migrate-export.ts:46](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-export.ts#L46) |
| <a id="property-writer"></a> `writer?` | `readonly` | `string` | Surfaced on the meta header. Defaults to `graphorin-cli@<version>` (the current package version). | - | [packages/cli/src/commands/migrate-export.ts:48](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/migrate-export.ts#L48) |
