...
Defined in: packages/cli/src/commands/secrets.ts:240
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | - | - | packages/cli/src/commands/secrets.ts:243 |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:241 |
| <a id="property-newvalue"></a> `newValue?` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:242 |
