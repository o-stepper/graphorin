...
Defined in: packages/cli/src/commands/secrets.ts:264
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | - | - | packages/cli/src/commands/secrets.ts:267 |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:265 |
| <a id="property-newvalue"></a> `newValue?` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:266 |
