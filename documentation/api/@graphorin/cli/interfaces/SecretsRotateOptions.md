...
Defined in: [packages/cli/src/commands/secrets.ts:240](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L240)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/secrets.ts:243](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L243) |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:241](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L241) |
| <a id="property-newvalue"></a> `newValue?` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:242](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L242) |
