...
Defined in: [packages/cli/src/commands/secrets.ts:261](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L261)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | - | - | [packages/cli/src/commands/secrets.ts:264](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L264) |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:262](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L262) |
| <a id="property-newvalue"></a> `newValue?` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:263](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L263) |
