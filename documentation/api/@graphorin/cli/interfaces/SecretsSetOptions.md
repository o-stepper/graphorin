...
Defined in: packages/cli/src/commands/secrets.ts:128
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | When `true`, read the value from stdin. | - | packages/cli/src/commands/secrets.ts:132 |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:129 |
...
| <a id="property-value"></a> `value?` | `readonly` | `string` | - | - | packages/cli/src/commands/secrets.ts:130 |
