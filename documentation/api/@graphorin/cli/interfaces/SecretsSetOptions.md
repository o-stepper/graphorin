...
Defined in: [packages/cli/src/commands/secrets.ts:131](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L131)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | When `true`, read the value from stdin. | - | [packages/cli/src/commands/secrets.ts:135](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L135) |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:132](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L132) |
...
| <a id="property-value"></a> `value?` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:133](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L133) |
