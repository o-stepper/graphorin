...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / SecretsSetOptions

# Interface: SecretsSetOptions

Defined in: [packages/cli/src/commands/secrets.ts:129](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L129)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-fromstdin"></a> `fromStdin?` | `readonly` | `boolean` | When `true`, read the value from stdin. | - | [packages/cli/src/commands/secrets.ts:133](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L133) |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | - | - | [packages/cli/src/commands/secrets.ts:130](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/commands/secrets.ts#L130) |
