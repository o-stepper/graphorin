...
Defined in: packages/cli/src/commands/audit.ts:174
...
| <a id="property-fromseq"></a> `fromSeq?` | `readonly` | `number` | - | - | packages/cli/src/commands/audit.ts:176 |
...
| <a id="property-to"></a> `to` | `readonly` | `string` | - | - | packages/cli/src/commands/audit.ts:175 |
| <a id="property-toseq"></a> `toSeq?` | `readonly` | `number` | - | - | packages/cli/src/commands/audit.ts:177 |
