...
Defined in: packages/cli/src/commands/audit.ts:154
...
| <a id="property-fromseq"></a> `fromSeq?` | `readonly` | `number` | - | - | packages/cli/src/commands/audit.ts:156 |
...
| <a id="property-to"></a> `to` | `readonly` | `string` | - | - | packages/cli/src/commands/audit.ts:155 |
| <a id="property-toseq"></a> `toSeq?` | `readonly` | `number` | - | - | packages/cli/src/commands/audit.ts:157 |
