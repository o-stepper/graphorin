...
Defined in: packages/cli/src/commands/audit.ts:150
...
| <a id="property-fromseq"></a> `fromSeq?` | `readonly` | `number` | - | - | packages/cli/src/commands/audit.ts:152 |
...
| <a id="property-to"></a> `to` | `readonly` | `string` | - | - | packages/cli/src/commands/audit.ts:151 |
| <a id="property-toseq"></a> `toSeq?` | `readonly` | `number` | - | - | packages/cli/src/commands/audit.ts:153 |
