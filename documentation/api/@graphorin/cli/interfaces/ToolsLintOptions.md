...
| <a id="property-countersink"></a> `counterSink?` | `readonly` | [`ToolsLintCounterSink`](/api/@graphorin/cli/type-aliases/ToolsLintCounterSink.md) | Optional sink for the `tool.lint.threshold.violations.total` counter. The CLI calls this once per below-threshold tool per invocation. Default: no-op. | - | packages/cli/src/commands/tools-lint.ts:106 |
