...
| <a id="property-chattimeoutms"></a> `chatTimeoutMs?` | `readonly` | `number` | Wall-clock bound for the smoke's chat leg. Default 60s. | - | packages/cli/src/commands/doctor.ts:111 |
...
| <a id="property-embedmodel"></a> `embedModel?` | `readonly` | `string` | Embedding model for the dimension probe. Default `nomic-embed-text`. | - | packages/cli/src/commands/doctor.ts:109 |
...
| <a id="property-ollamabaseurl"></a> `ollamaBaseUrl?` | `readonly` | `string` | Ollama base URL for the smoke. Default `http://127.0.0.1:11434`. | - | packages/cli/src/commands/doctor.ts:105 |
| <a id="property-ollamamodel"></a> `ollamaModel?` | `readonly` | `string` | Chat model the smoke exercises end to end (streaming + tool call). | - | packages/cli/src/commands/doctor.ts:107 |
...
| <a id="property-smokedir"></a> `smokeDir?` | `readonly` | `string` | Test seam - directory for the smoke's throwaway store. | - | packages/cli/src/commands/doctor.ts:115 |
| <a id="property-smokefetchimpl"></a> `smokeFetchImpl?` | `readonly` | (`input`, `init?`) => `Promise`\&lt;`Response`\&gt; | Test seam - injected fetch for the smoke's Ollama calls. | - | packages/cli/src/commands/doctor.ts:113 |
