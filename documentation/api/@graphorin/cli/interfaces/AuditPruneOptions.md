...
Defined in: packages/cli/src/commands/audit.ts:101
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-before"></a> `before` | `readonly` | `string` | ISO-8601 date / `YYYY-MM-DD` / millis-since-epoch. The helper drops entries older than this cutoff. | - | packages/cli/src/commands/audit.ts:106 |
...
| <a id="property-retain"></a> `retain?` | `readonly` | `number` | Minimum number of entries that must survive. Default `1`. | - | packages/cli/src/commands/audit.ts:108 |
