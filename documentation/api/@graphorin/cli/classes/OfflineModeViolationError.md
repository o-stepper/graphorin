...
[Graphorin API reference](/api/index.md) / [@graphorin/cli](/api/@graphorin/cli/index.md) / [](/api/@graphorin/cli/README.md) / OfflineModeViolationError

# Class: OfflineModeViolationError

Defined in: [packages/cli/src/internal/offline.ts:70](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/internal/offline.ts#L70)
...
```ts
new OfflineModeViolationError(operation): OfflineModeViolationError;
```

Defined in: [packages/cli/src/internal/offline.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/internal/offline.ts#L74)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"offline-mode-violation"` | - | - | [packages/cli/src/internal/offline.ts:71](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/internal/offline.ts#L71) |
...
| <a id="property-operation"></a> `operation` | `readonly` | `string` | - | - | [packages/cli/src/internal/offline.ts:72](https://github.com/o-stepper/graphorin/blob/main/packages/cli/src/internal/offline.ts#L72) |
