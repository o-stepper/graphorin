...
>
> Project Graphorin · v0.13.6 · MIT License · © 2026 Oleksiy Stepurenko ·
...
- **Published:** v0.13.6 (optional sub-pack)
...
| Module | Description |
| ------ | ------ |
| [](/api/@graphorin/store-sqlite-encrypted/README.md) | @graphorin/store-sqlite-encrypted - optional encryption-at-rest sub-pack for the Graphorin framework's default SQLite store. |
| [package.json](/api/@graphorin/store-sqlite-encrypted/package.json/index.md) | - |
