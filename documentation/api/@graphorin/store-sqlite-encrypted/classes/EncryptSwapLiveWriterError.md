...
Defined in: packages/store-sqlite-encrypted/src/encrypt.ts:107
...
Defined in: packages/store-sqlite-encrypted/src/encrypt.ts:131
...
| <a id="property-sourcepath"></a> `sourcePath` | `readonly` | `string` | - | - | packages/store-sqlite-encrypted/src/encrypt.ts:108 |
