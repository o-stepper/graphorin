...
Defined in: packages/workflow/src/timer-driver.ts:45
...
Defined in: packages/workflow/src/timer-driver.ts:47
...
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | packages/workflow/src/timer-driver.ts:46 |
