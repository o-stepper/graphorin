...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [](/api/@graphorin/workflow/README.md) / TimerDriverStoreUnsupportedError

# Class: TimerDriverStoreUnsupportedError

Defined in: [packages/workflow/src/timer-driver.ts:44](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/timer-driver.ts#L44)

Thrown by [createTimerDriver](/api/@graphorin/workflow/functions/createTimerDriver.md) when an entry's checkpoint store
...
```ts
new TimerDriverStoreUnsupportedError(workflowName, storeName): TimerDriverStoreUnsupportedError;
```

Defined in: [packages/workflow/src/timer-driver.ts:46](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/timer-driver.ts#L46)
...
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | [packages/workflow/src/timer-driver.ts:45](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/timer-driver.ts#L45) |
