...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-pause_signal_brand"></a> `[PAUSE_SIGNAL_BRAND]` | `readonly` | `true` | - | - | [packages/core/dist/channels/pause.d.ts](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/channels/pause.d.ts) |
...
| <a id="property-value"></a> `value` | `readonly` | `TValue` | - | - | [packages/core/dist/channels/pause.d.ts](https://github.com/o-stepper/graphorin/blob/main/packages/core/dist/channels/pause.d.ts) |
