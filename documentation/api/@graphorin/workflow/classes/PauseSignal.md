...
Defined in: packages/core/dist/channels/pause.d.ts:23
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-pause_signal_brand"></a> `[PAUSE_SIGNAL_BRAND]` | `readonly` | `true` | - | - | packages/core/dist/channels/pause.d.ts:21 |
...
| <a id="property-value"></a> `value` | `readonly` | `TValue` | - | - | packages/core/dist/channels/pause.d.ts:22 |
