...
Defined in: packages/workflow/src/errors/index.ts:278
...
| <a id="property-pausename"></a> `pauseName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:276 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:275 |
