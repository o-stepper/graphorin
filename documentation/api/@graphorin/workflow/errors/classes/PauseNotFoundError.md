...
Defined in: packages/workflow/src/errors/index.ts:275
...
Defined in: packages/workflow/src/errors/index.ts:279
...
| <a id="property-pausename"></a> `pauseName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:277 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:276 |
