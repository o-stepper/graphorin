...
Defined in: [packages/workflow/src/errors/index.ts:274](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L274)
...
Defined in: [packages/workflow/src/errors/index.ts:278](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L278)
...
| <a id="property-pausename"></a> `pauseName` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:276](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L276) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:275](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L275) |
