...
Defined in: packages/workflow/src/errors/index.ts:349
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:346 |
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:347 |
