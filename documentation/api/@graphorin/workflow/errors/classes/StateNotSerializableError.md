...
Defined in: packages/workflow/src/errors/index.ts:344
...
Defined in: packages/workflow/src/errors/index.ts:348
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:345 |
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:346 |
