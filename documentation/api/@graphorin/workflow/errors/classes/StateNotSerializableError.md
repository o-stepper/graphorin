...
Defined in: packages/workflow/src/errors/index.ts:346
...
Defined in: packages/workflow/src/errors/index.ts:350
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:347 |
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:348 |
