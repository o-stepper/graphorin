...
Defined in: packages/workflow/src/errors/index.ts:244
...
Defined in: packages/workflow/src/errors/index.ts:248
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:245 |
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:246 |
