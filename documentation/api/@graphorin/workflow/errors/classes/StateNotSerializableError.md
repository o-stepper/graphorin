...
Defined in: packages/workflow/src/errors/index.ts:341
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:338 |
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:339 |
