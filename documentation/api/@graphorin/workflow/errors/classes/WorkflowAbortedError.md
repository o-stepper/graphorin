...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / WorkflowAbortedError

# Class: WorkflowAbortedError

Defined in: packages/workflow/src/errors/index.ts:167
...
```ts
new WorkflowAbortedError(threadId, reason?): WorkflowAbortedError;
```

Defined in: packages/workflow/src/errors/index.ts:170
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:168 |
