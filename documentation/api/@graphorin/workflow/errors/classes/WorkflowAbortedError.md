...
Defined in: packages/workflow/src/errors/index.ts:173
...
Defined in: packages/workflow/src/errors/index.ts:176
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:174 |
