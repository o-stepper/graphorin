...
Defined in: packages/workflow/src/errors/index.ts:175
...
Defined in: packages/workflow/src/errors/index.ts:178
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:176 |
