...
Defined in: packages/workflow/src/errors/index.ts:169
...
Defined in: packages/workflow/src/errors/index.ts:172
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:170 |
