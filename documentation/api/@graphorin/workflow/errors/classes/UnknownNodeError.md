...
Defined in: packages/workflow/src/errors/index.ts:107
...
Defined in: packages/workflow/src/errors/index.ts:110
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:108 |
