...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / UnknownNodeError

# Class: UnknownNodeError

Defined in: packages/workflow/src/errors/index.ts:101
...
```ts
new UnknownNodeError(nodeName, context): UnknownNodeError;
```

Defined in: packages/workflow/src/errors/index.ts:104
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:102 |
