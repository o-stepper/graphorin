...
Defined in: packages/workflow/src/errors/index.ts:103
...
Defined in: packages/workflow/src/errors/index.ts:106
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:104 |
