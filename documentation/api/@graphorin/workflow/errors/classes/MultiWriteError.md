...
Defined in: [packages/workflow/src/errors/index.ts:90](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L90)
...
Defined in: [packages/workflow/src/errors/index.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L94)
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:91](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L91) |
...
| <a id="property-writers"></a> `writers` | `readonly` | readonly `string`[] | - | - | [packages/workflow/src/errors/index.ts:92](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L92) |
