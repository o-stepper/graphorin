...
Defined in: packages/workflow/src/errors/index.ts:90
...
Defined in: packages/workflow/src/errors/index.ts:94
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:91 |
...
| <a id="property-writers"></a> `writers` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:92 |
