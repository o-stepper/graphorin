...
Defined in: packages/workflow/src/errors/index.ts:91
...
Defined in: packages/workflow/src/errors/index.ts:95
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:92 |
...
| <a id="property-writers"></a> `writers` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:93 |
