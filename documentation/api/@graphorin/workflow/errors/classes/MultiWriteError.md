...
Defined in: [packages/workflow/src/errors/index.ts:89](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L89)
...
Defined in: [packages/workflow/src/errors/index.ts:93](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L93)
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:90](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L90) |
...
| <a id="property-writers"></a> `writers` | `readonly` | readonly `string`[] | - | - | [packages/workflow/src/errors/index.ts:91](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L91) |
