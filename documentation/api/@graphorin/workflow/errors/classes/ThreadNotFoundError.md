...
Defined in: packages/workflow/src/errors/index.ts:114
...
Defined in: packages/workflow/src/errors/index.ts:117
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:115 |
