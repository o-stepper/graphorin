...
Defined in: packages/workflow/src/errors/index.ts:112
...
Defined in: packages/workflow/src/errors/index.ts:115
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:113 |
