...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / ThreadNotFoundError

# Class: ThreadNotFoundError

Defined in: packages/workflow/src/errors/index.ts:118
...
```ts
new ThreadNotFoundError(threadId): ThreadNotFoundError;
```

Defined in: packages/workflow/src/errors/index.ts:121
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:119 |
