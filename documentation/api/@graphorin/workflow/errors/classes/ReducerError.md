...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / ReducerError

# Class: ReducerError

Defined in: packages/workflow/src/errors/index.ts:194
...
Defined in: packages/workflow/src/errors/index.ts:197
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:195 |
