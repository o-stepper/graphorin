...
Defined in: packages/workflow/src/errors/index.ts:190
...
Defined in: packages/workflow/src/errors/index.ts:193
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:191 |
