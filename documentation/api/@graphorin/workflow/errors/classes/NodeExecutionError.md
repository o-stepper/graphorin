...
Defined in: packages/workflow/src/errors/index.ts:183
...
Defined in: packages/workflow/src/errors/index.ts:186
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:184 |
