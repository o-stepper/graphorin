...
Defined in: packages/workflow/src/errors/index.ts:185
...
Defined in: packages/workflow/src/errors/index.ts:188
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:186 |
