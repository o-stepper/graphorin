...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / NodeExecutionError

# Class: NodeExecutionError

Defined in: packages/workflow/src/errors/index.ts:189
...
```ts
new NodeExecutionError(nodeName, cause): NodeExecutionError;
```

Defined in: packages/workflow/src/errors/index.ts:192
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:190 |
