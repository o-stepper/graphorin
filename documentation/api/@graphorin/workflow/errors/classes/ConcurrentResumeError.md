...
Defined in: packages/workflow/src/errors/index.ts:143
...
Defined in: packages/workflow/src/errors/index.ts:146
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:144 |
