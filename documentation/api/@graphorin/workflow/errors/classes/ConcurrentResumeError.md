...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / ConcurrentResumeError

# Class: ConcurrentResumeError

Defined in: packages/workflow/src/errors/index.ts:136
...
```ts
new ConcurrentResumeError(threadId): ConcurrentResumeError;
```

Defined in: packages/workflow/src/errors/index.ts:139
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:137 |
