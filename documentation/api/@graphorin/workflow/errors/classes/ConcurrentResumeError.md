...
Defined in: packages/workflow/src/errors/index.ts:142
...
Defined in: packages/workflow/src/errors/index.ts:145
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:143 |
