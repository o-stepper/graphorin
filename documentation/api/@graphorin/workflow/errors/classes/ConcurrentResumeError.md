...
Defined in: packages/workflow/src/errors/index.ts:144
...
Defined in: packages/workflow/src/errors/index.ts:147
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:145 |
