...
Defined in: packages/workflow/src/errors/index.ts:138
...
Defined in: packages/workflow/src/errors/index.ts:141
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:139 |
