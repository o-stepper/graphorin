...
Defined in: [packages/workflow/src/errors/index.ts:251](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L251)
...
Defined in: [packages/workflow/src/errors/index.ts:255](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L255)
...
| <a id="property-missingnodes"></a> `missingNodes` | `readonly` | readonly `string`[] | - | - | [packages/workflow/src/errors/index.ts:253](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L253) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:252](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L252) |
