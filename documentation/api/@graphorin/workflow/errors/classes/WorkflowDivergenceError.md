...
Defined in: [packages/workflow/src/errors/index.ts:252](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L252)
...
Defined in: [packages/workflow/src/errors/index.ts:256](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L256)
...
| <a id="property-missingnodes"></a> `missingNodes` | `readonly` | readonly `string`[] | - | - | [packages/workflow/src/errors/index.ts:254](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L254) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:253](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L253) |
