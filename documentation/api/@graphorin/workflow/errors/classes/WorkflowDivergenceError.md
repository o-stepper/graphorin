...
Defined in: packages/workflow/src/errors/index.ts:253
...
Defined in: packages/workflow/src/errors/index.ts:257
...
| <a id="property-missingnodes"></a> `missingNodes` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:255 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:254 |
