...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / WorkflowDivergenceError

# Class: WorkflowDivergenceError

Defined in: packages/workflow/src/errors/index.ts:251
...
```ts
new WorkflowDivergenceError(threadId, missingNodes): WorkflowDivergenceError;
```

Defined in: packages/workflow/src/errors/index.ts:255
...
| <a id="property-missingnodes"></a> `missingNodes` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:253 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:252 |
