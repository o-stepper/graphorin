...
Defined in: packages/workflow/src/errors/index.ts:256
...
| <a id="property-missingnodes"></a> `missingNodes` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:254 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:253 |
