...
Defined in: packages/workflow/src/errors/index.ts:231
...
| <a id="property-currentversion"></a> `currentVersion` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:229 |
...
| <a id="property-storedversion"></a> `storedVersion` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:228 |
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:227 |
