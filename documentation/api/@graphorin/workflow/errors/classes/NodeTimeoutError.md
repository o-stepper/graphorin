...
Defined in: packages/workflow/src/errors/index.ts:208
...
Defined in: packages/workflow/src/errors/index.ts:212
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:209 |
...
| <a id="property-timeoutms"></a> `timeoutMs` | `readonly` | `number` | - | - | packages/workflow/src/errors/index.ts:210 |
