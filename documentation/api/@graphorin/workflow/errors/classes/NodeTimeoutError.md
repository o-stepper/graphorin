...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / NodeTimeoutError
...
```ts
new NodeTimeoutError(nodeName, timeoutMs): NodeTimeoutError;
```

Defined in: packages/workflow/src/errors/index.ts:209
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:206 |
...
| <a id="property-timeoutms"></a> `timeoutMs` | `readonly` | `number` | - | - | packages/workflow/src/errors/index.ts:207 |
