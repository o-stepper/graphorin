...
Defined in: packages/workflow/src/errors/index.ts:211
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:208 |
...
| <a id="property-timeoutms"></a> `timeoutMs` | `readonly` | `number` | - | - | packages/workflow/src/errors/index.ts:209 |
