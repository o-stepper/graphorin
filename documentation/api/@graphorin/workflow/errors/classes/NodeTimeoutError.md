...
Defined in: packages/workflow/src/errors/index.ts:206
...
Defined in: packages/workflow/src/errors/index.ts:210
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:207 |
...
| <a id="property-timeoutms"></a> `timeoutMs` | `readonly` | `number` | - | - | packages/workflow/src/errors/index.ts:208 |
