...
Defined in: [packages/workflow/src/errors/index.ts:207](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L207)
...
Defined in: [packages/workflow/src/errors/index.ts:211](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L211)
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:208](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L208) |
...
| <a id="property-timeoutms"></a> `timeoutMs` | `readonly` | `number` | - | - | [packages/workflow/src/errors/index.ts:209](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L209) |
