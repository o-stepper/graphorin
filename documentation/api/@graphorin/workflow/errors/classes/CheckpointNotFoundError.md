...
Defined in: packages/workflow/src/errors/index.ts:134
...
| <a id="property-checkpointid"></a> `checkpointId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:132 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:131 |
