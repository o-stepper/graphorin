...
Defined in: [packages/workflow/src/errors/index.ts:130](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L130)
...
Defined in: [packages/workflow/src/errors/index.ts:134](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L134)
...
| <a id="property-checkpointid"></a> `checkpointId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:132](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L132) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:131](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L131) |
