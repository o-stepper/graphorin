...
Defined in: [packages/workflow/src/errors/index.ts:131](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L131)
...
Defined in: [packages/workflow/src/errors/index.ts:135](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L135)
...
| <a id="property-checkpointid"></a> `checkpointId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:133](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L133) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:132](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L132) |
