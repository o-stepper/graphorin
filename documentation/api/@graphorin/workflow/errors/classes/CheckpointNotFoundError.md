...
Defined in: packages/workflow/src/errors/index.ts:131
...
Defined in: packages/workflow/src/errors/index.ts:135
...
| <a id="property-checkpointid"></a> `checkpointId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:133 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:132 |
