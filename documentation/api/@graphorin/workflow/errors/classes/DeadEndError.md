...
Defined in: packages/workflow/src/errors/index.ts:320
...
| <a id="property-stallednodes"></a> `stalledNodes` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:318 |
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:317 |
