...
Defined in: packages/workflow/src/errors/index.ts:319
...
Defined in: packages/workflow/src/errors/index.ts:323
...
| <a id="property-stallednodes"></a> `stalledNodes` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:321 |
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:320 |
