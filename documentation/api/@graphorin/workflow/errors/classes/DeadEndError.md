...
Defined in: [packages/workflow/src/errors/index.ts:317](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L317)
...
Defined in: [packages/workflow/src/errors/index.ts:321](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L321)
...
| <a id="property-stallednodes"></a> `stalledNodes` | `readonly` | readonly `string`[] | - | - | [packages/workflow/src/errors/index.ts:319](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L319) |
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:318](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L318) |
