...
Defined in: [packages/workflow/src/errors/index.ts:318](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L318)
...
Defined in: [packages/workflow/src/errors/index.ts:322](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L322)
...
| <a id="property-stallednodes"></a> `stalledNodes` | `readonly` | readonly `string`[] | - | - | [packages/workflow/src/errors/index.ts:320](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L320) |
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:319](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L319) |
