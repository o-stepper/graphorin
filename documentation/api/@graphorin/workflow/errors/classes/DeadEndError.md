...
Defined in: packages/workflow/src/errors/index.ts:223
...
| <a id="property-stallednodes"></a> `stalledNodes` | `readonly` | readonly `string`[] | - | - | packages/workflow/src/errors/index.ts:225 |
| <a id="property-workflowname"></a> `workflowName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:224 |
