...
[Graphorin API reference](/api/index.md) / [@graphorin/workflow](/api/@graphorin/workflow/index.md) / [errors](/api/@graphorin/workflow/errors/index.md) / InvalidWorkflowConfigError

# Class: InvalidWorkflowConfigError

Defined in: packages/workflow/src/errors/index.ts:59
...
Defined in: packages/workflow/src/errors/index.ts:60
