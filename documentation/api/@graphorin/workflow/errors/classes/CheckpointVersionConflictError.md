...
Defined in: [packages/workflow/src/errors/index.ts:294](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L294)
...
Defined in: [packages/workflow/src/errors/index.ts:299](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L299)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actuallatestid"></a> `actualLatestId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:297](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L297) |
...
| <a id="property-expectedparentid"></a> `expectedParentId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:296](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L296) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:295](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L295) |
