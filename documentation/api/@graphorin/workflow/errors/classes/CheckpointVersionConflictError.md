...
Defined in: packages/workflow/src/errors/index.ts:300
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actuallatestid"></a> `actualLatestId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:298 |
...
| <a id="property-expectedparentid"></a> `expectedParentId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:297 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:296 |
