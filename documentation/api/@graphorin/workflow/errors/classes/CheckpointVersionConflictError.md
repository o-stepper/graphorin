...
Defined in: packages/workflow/src/errors/index.ts:296
...
Defined in: packages/workflow/src/errors/index.ts:301
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actuallatestid"></a> `actualLatestId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:299 |
...
| <a id="property-expectedparentid"></a> `expectedParentId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:298 |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:297 |
