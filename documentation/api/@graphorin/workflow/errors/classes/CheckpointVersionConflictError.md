...
Defined in: [packages/workflow/src/errors/index.ts:295](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L295)
...
Defined in: [packages/workflow/src/errors/index.ts:300](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L300)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actuallatestid"></a> `actualLatestId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:298](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L298) |
...
| <a id="property-expectedparentid"></a> `expectedParentId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:297](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L297) |
...
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:296](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L296) |
