...
Defined in: [packages/workflow/src/errors/index.ts:72](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L72)
...
Defined in: [packages/workflow/src/errors/index.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L76)
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L74) |
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:73](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L73) |
