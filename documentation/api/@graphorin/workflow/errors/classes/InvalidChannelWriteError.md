...
Defined in: packages/workflow/src/errors/index.ts:74
...
Defined in: packages/workflow/src/errors/index.ts:78
...
| <a id="property-channel"></a> `channel` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:76 |
...
| <a id="property-nodename"></a> `nodeName` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:75 |
