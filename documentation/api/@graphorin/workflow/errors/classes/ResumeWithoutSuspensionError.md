...
Defined in: [packages/workflow/src/errors/index.ts:159](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L159)
...
Defined in: [packages/workflow/src/errors/index.ts:163](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L163)
...
| <a id="property-status"></a> `status` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:161](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L161) |
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:160](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L160) |
