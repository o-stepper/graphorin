...
Defined in: packages/workflow/src/errors/index.ts:160
...
Defined in: packages/workflow/src/errors/index.ts:164
...
| <a id="property-status"></a> `status` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:162 |
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:161 |
