...
Defined in: [packages/workflow/src/errors/index.ts:158](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L158)
...
Defined in: [packages/workflow/src/errors/index.ts:162](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L162)
...
| <a id="property-status"></a> `status` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:160](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L160) |
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | [packages/workflow/src/errors/index.ts:159](https://github.com/o-stepper/graphorin/blob/main/packages/workflow/src/errors/index.ts#L159) |
