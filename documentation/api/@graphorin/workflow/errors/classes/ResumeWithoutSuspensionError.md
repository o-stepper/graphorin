...
Defined in: packages/workflow/src/errors/index.ts:162
...
| <a id="property-status"></a> `status` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:160 |
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:159 |
