...
Defined in: packages/workflow/src/errors/index.ts:159
...
Defined in: packages/workflow/src/errors/index.ts:163
...
| <a id="property-status"></a> `status` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:161 |
| <a id="property-threadid"></a> `threadId` | `readonly` | `string` | - | - | packages/workflow/src/errors/index.ts:160 |
