...
Defined in: packages/core/src/types/usage.ts:79
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-bymodel"></a> `byModel` | `readonly` | `ReadonlyMap`\&lt;`string`, [`ModelUsage`](/api/@graphorin/core/interfaces/ModelUsage.md)\&gt; | Per-model breakdown; preserves call counts for observability. | packages/core/src/types/usage.ts:83 |
| <a id="property-total"></a> `total` | `readonly` | [`Usage`](/api/@graphorin/core/interfaces/Usage.md) | Current rolled-up totals across every model that has been added. | packages/core/src/types/usage.ts:81 |
...
Defined in: packages/core/src/types/usage.ts:86
...
Defined in: packages/core/src/types/usage.ts:88
...
Defined in: packages/core/src/types/usage.ts:90
