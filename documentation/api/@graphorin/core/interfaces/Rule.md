...
| <a id="property-owner"></a> `owner?` | `readonly` | [`MemoryOwner`](/api/@graphorin/core/type-aliases/MemoryOwner.md) | Principal dimension. `'agent'` on induced procedures. See [MemoryOwner](/api/@graphorin/core/type-aliases/MemoryOwner.md). | - | - | packages/core/src/types/memory.ts:267 |
| <a id="property-priority"></a> `priority` | `readonly` | `number` | - | - | - | packages/core/src/types/memory.ts:224 |
| <a id="property-provenance"></a> `provenance?` | `readonly` | [`MemoryProvenance`](/api/@graphorin/core/type-aliases/MemoryProvenance.md) | Trust-provenance tag. Induced procedures are `'induction'`; author-defined rules omit it (treated first-party). See [MemoryProvenance](/api/@graphorin/core/type-aliases/MemoryProvenance.md). | - | - | packages/core/src/types/memory.ts:250 |
