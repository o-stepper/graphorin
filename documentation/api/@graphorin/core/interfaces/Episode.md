...
Defined in: packages/core/src/types/memory.ts:99
...
| <a id="property-endedat"></a> `endedAt` | `readonly` | `string` | ISO-8601 of the latest event in the episode. | - | - | packages/core/src/types/memory.ts:105 |
...
| <a id="property-importance"></a> `importance?` | `readonly` | `number` | Optional importance score in `[0, 1]`. | - | - | packages/core/src/types/memory.ts:107 |
| <a id="property-kind"></a> `kind` | `readonly` | `"episodic"` | - | [`MemoryRecord`](/api/@graphorin/core/interfaces/MemoryRecord.md).[`kind`](/api/@graphorin/core/interfaces/MemoryRecord.md#property-kind) | - | packages/core/src/types/memory.ts:100 |
...
| <a id="property-startedat"></a> `startedAt` | `readonly` | `string` | ISO-8601 of the earliest event in the episode. | - | - | packages/core/src/types/memory.ts:103 |
| <a id="property-summary"></a> `summary` | `readonly` | `string` | - | - | - | packages/core/src/types/memory.ts:101 |
