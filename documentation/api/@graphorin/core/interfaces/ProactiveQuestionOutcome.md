...
Defined in: [packages/core/src/types/proactive.ts:111](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L111)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"question"` | - | - | [packages/core/src/types/proactive.ts:112](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L112) |
| <a id="property-options"></a> `options?` | `readonly` | readonly [`ProactiveOutcomeOption`](/api/@graphorin/core/interfaces/ProactiveOutcomeOption.md)[] | - | - | [packages/core/src/types/proactive.ts:114](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L114) |
| <a id="property-ref"></a> `ref` | `readonly` | `string` | - | - | [packages/core/src/types/proactive.ts:113](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L113) |
