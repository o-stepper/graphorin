...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-causalitychain"></a> `causalityChain?` | `readonly` | readonly `string`[] | See [TextContent.causalityChain](/api/@graphorin/core/interfaces/TextContent.md#property-causalitychain). | packages/core/src/types/message.ts:106 |
...
| <a id="property-text"></a> `text` | `readonly` | `string` | - | packages/core/src/types/message.ts:91 |
| <a id="property-type"></a> `type` | `readonly` | `"reasoning"` | - | packages/core/src/types/message.ts:90 |
