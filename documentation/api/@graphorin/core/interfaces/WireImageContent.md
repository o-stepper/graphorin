...
Defined in: [packages/core/src/utils/binary-json.ts:65](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/utils/binary-json.ts#L65)
...
| <a id="property-image"></a> `image` | `readonly` | [`EncodedBinary`](/api/@graphorin/core/type-aliases/EncodedBinary.md) | - | - | [packages/core/src/utils/binary-json.ts:66](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/utils/binary-json.ts#L66) |
