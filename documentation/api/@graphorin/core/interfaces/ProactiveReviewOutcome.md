...
Defined in: [packages/core/src/types/proactive.ts:124](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L124)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"review"` | - | - | [packages/core/src/types/proactive.ts:125](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L125) |
| <a id="property-options"></a> `options?` | `readonly` | readonly [`ProactiveOutcomeOption`](/api/@graphorin/core/interfaces/ProactiveOutcomeOption.md)[] | - | - | [packages/core/src/types/proactive.ts:127](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L127) |
| <a id="property-ref"></a> `ref` | `readonly` | `string` | - | - | [packages/core/src/types/proactive.ts:126](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L126) |
