...
Defined in: [packages/core/src/types/proactive.ts:138](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L138)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"act"` | - | - | [packages/core/src/types/proactive.ts:139](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/types/proactive.ts#L139) |
