...
Defined in: packages/core/src/types/memory.ts:66
...
| <a id="property-charlimit"></a> `charLimit` | `readonly` | `number` | - | - | - | packages/core/src/types/memory.ts:71 |
...
| <a id="property-description"></a> `description?` | `readonly` | `string` | - | - | - | packages/core/src/types/memory.ts:69 |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"working"` | - | [`MemoryRecord`](/api/@graphorin/core/interfaces/MemoryRecord.md).[`kind`](/api/@graphorin/core/interfaces/MemoryRecord.md#property-kind) | - | packages/core/src/types/memory.ts:67 |
| <a id="property-label"></a> `label` | `readonly` | `string` | - | - | - | packages/core/src/types/memory.ts:68 |
| <a id="property-readonly"></a> `readOnly?` | `readonly` | `boolean` | - | - | - | packages/core/src/types/memory.ts:72 |
...
| <a id="property-value"></a> `value` | `readonly` | `string` | - | - | - | packages/core/src/types/memory.ts:70 |
