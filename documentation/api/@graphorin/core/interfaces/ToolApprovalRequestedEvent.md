...
| ------ | ------ | ------ | ------ |
| <a id="property-reason"></a> `reason?` | `readonly` | `string` | packages/core/src/types/agent-event.ts:170 |
| <a id="property-toolcallid"></a> `toolCallId` | `readonly` | `string` | packages/core/src/types/agent-event.ts:169 |
| <a id="property-type"></a> `type` | `readonly` | `"tool.approval.requested"` | packages/core/src/types/agent-event.ts:168 |
