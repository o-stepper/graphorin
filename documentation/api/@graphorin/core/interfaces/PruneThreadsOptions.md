...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-beforeepochms"></a> `beforeEpochMs` | `readonly` | `number` | Cutoff: a `(threadId, namespace)` pair qualifies when its LATEST checkpoint (by `stepNumber`) was created before this epoch-ms instant. | packages/core/src/contracts/checkpoint-store.ts:212 |
