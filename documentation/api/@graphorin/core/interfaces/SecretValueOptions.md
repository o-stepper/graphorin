...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-source"></a> `source?` | `readonly` | \{ `ref?`: `string`; `resolver?`: `string`; \} | Free-form provenance string for the audit log. | packages/core/src/contracts/secret-value.ts:116 |
