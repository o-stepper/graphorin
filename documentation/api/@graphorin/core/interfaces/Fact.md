...
| <a id="property-confidence"></a> `confidence?` | `readonly` | `number` | - | - | - | packages/core/src/types/memory.ts:83 |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"semantic"` | - | [`MemoryRecord`](/api/@graphorin/core/interfaces/MemoryRecord.md).[`kind`](/api/@graphorin/core/interfaces/MemoryRecord.md#property-kind) | - | packages/core/src/types/memory.ts:81 |
...
| <a id="property-supersededby"></a> `supersededBy?` | `readonly` | `string` | ID of the fact that supersedes this one, if any. | - | - | packages/core/src/types/memory.ts:91 |
| <a id="property-supersedes"></a> `supersedes?` | `readonly` | `string` | ID of the fact this one supersedes, if any. | - | - | packages/core/src/types/memory.ts:89 |
...
| <a id="property-text"></a> `text` | `readonly` | `string` | - | - | - | packages/core/src/types/memory.ts:82 |
...
| <a id="property-validfrom"></a> `validFrom?` | `readonly` | `string` | Bi-temporal: when the fact became true, ISO-8601. | - | - | packages/core/src/types/memory.ts:85 |
| <a id="property-validto"></a> `validTo?` | `readonly` | `string` | Bi-temporal: when the fact stopped being true, ISO-8601. | - | - | packages/core/src/types/memory.ts:87 |
