...
Defined in: [packages/core/src/contracts/tracer.ts:120](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/contracts/tracer.ts#L120)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-sensitivity"></a> `sensitivity?` | `readonly` | [`Sensitivity`](/api/@graphorin/core/type-aliases/Sensitivity.md) | Default tier applied to every attribute of this event. | [packages/core/src/contracts/tracer.ts:122](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/contracts/tracer.ts#L122) |
| <a id="property-sensitivitybyattribute"></a> `sensitivityByAttribute?` | `readonly` | `Readonly`\<`Record`\&lt;`string`, [`Sensitivity`](/api/@graphorin/core/type-aliases/Sensitivity.md)\&gt;\> | Per-attribute overrides; win over [AddEventOptions.sensitivity](/api/@graphorin/core/interfaces/AddEventOptions.md#property-sensitivity). | [packages/core/src/contracts/tracer.ts:124](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/contracts/tracer.ts#L124) |
