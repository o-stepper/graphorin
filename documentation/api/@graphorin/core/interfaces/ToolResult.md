...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-contentparts"></a> `contentParts?` | `readonly` | readonly [`MessageContent`](/api/@graphorin/core/type-aliases/MessageContent.md)[] | Optional content parts to append to the conversation (images, files, etc.). Tools that emit binary results use this field instead of trying to encode the binary into `output`. | packages/core/src/types/tool.ts:177 |
| <a id="property-durationms"></a> `durationMs` | `readonly` | `number` | - | packages/core/src/types/tool.ts:178 |
| <a id="property-output"></a> `output` | `readonly` | `TOutput` | - | packages/core/src/types/tool.ts:171 |
| <a id="property-toolcallid"></a> `toolCallId` | `readonly` | `string` | - | packages/core/src/types/tool.ts:169 |
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | packages/core/src/types/tool.ts:170 |
