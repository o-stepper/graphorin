...
Defined in: [packages/core/src/contracts/memory-store.ts:80](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/contracts/memory-store.ts#L80)
