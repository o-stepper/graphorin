...
Defined in: [packages/core/src/channels/pause.ts:68](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/channels/pause.ts#L68)
...
Defined in: [packages/core/src/channels/pause.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/channels/pause.ts#L74)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-replay_divergence_brand"></a> `[REPLAY_DIVERGENCE_BRAND]` | `readonly` | `true` | `true` | - | - | [packages/core/src/channels/pause.ts:69](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/channels/pause.ts#L69) |
| <a id="property-actual"></a> `actual` | `readonly` | [`PauseIdentity`](/api/@graphorin/core/interfaces/PauseIdentity.md) | `undefined` | - | - | [packages/core/src/channels/pause.ts:71](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/channels/pause.ts#L71) |
...
| <a id="property-cursor"></a> `cursor` | `readonly` | `number` | `undefined` | - | - | [packages/core/src/channels/pause.ts:72](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/channels/pause.ts#L72) |
| <a id="property-expected"></a> `expected` | `readonly` | [`PauseIdentity`](/api/@graphorin/core/interfaces/PauseIdentity.md) | `undefined` | - | - | [packages/core/src/channels/pause.ts:70](https://github.com/o-stepper/graphorin/blob/main/packages/core/src/channels/pause.ts#L70) |
...
| <a id="property-name"></a> `name` | `public` | `string` | `undefined` | - | `Error.name` | [node\_modules/.pnpm/typescript@5.9.3/node\_modules/typescript/lib/lib.es5.d.ts:1076](https://github.com/o-stepper/graphorin/blob/main/node_modules/.pnpm/typescript@5.9.3/node_modules/typescript/lib/lib.es5.d.ts#L1076) |
