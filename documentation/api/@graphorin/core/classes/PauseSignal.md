...
[Graphorin API reference](/api/index.md) / [@graphorin/core](/api/@graphorin/core/index.md) / [](/api/@graphorin/core/README.md) / PauseSignal
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-pause_signal_brand"></a> `[PAUSE_SIGNAL_BRAND]` | `readonly` | `true` | `true` | - | - | packages/core/src/channels/pause.ts:23 |
...
| <a id="property-value"></a> `value` | `readonly` | `TValue` | `undefined` | - | - | packages/core/src/channels/pause.ts:24 |
