...
Defined in: [packages/embedder-transformersjs/src/index.ts:115](https://github.com/o-stepper/graphorin/blob/main/packages/embedder-transformersjs/src/index.ts#L115)
...
| <a id="property-name"></a> `name` | `readonly` | `"EmbedderModelLoadError"` | `'EmbedderModelLoadError'` | - | `Error.name` | - | [packages/embedder-transformersjs/src/index.ts:116](https://github.com/o-stepper/graphorin/blob/main/packages/embedder-transformersjs/src/index.ts#L116) |
