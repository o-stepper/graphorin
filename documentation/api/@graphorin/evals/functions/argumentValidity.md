...
[Graphorin API reference](/api/index.md) / [@graphorin/evals](/api/@graphorin/evals/index.md) / [](/api/@graphorin/evals/README.md) / argumentValidity
...
| Parameter | Type |
| ------ | ------ |
| `options` | [`ArgumentValidityOptions`](/api/@graphorin/evals/interfaces/ArgumentValidityOptions.md) |
