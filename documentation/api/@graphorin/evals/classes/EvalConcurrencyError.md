...
[Graphorin API reference](/api/index.md) / [@graphorin/evals](/api/@graphorin/evals/index.md) / [](/api/@graphorin/evals/README.md) / EvalConcurrencyError

# Class: EvalConcurrencyError

Defined in: [packages/evals/src/runner.ts:43](https://github.com/o-stepper/graphorin/blob/main/packages/evals/src/runner.ts#L43)
...
```ts
new EvalConcurrencyError(message, cause): EvalConcurrencyError;
```

Defined in: [packages/evals/src/runner.ts:44](https://github.com/o-stepper/graphorin/blob/main/packages/evals/src/runner.ts#L44)
