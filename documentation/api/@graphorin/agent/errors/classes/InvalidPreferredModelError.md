...
Defined in: [packages/agent/src/errors/index.ts:73](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L73)
...
Defined in: [packages/agent/src/errors/index.ts:75](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L75)
...
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | [packages/agent/src/errors/index.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L74) |
