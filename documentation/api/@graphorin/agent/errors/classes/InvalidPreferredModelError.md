...
Defined in: packages/agent/src/errors/index.ts:72
...
Defined in: packages/agent/src/errors/index.ts:74
...
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | packages/agent/src/errors/index.ts:73 |
