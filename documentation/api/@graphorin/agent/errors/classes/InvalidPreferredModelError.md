...
Defined in: packages/agent/src/errors/index.ts:71
...
Defined in: packages/agent/src/errors/index.ts:73
...
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | packages/agent/src/errors/index.ts:72 |
