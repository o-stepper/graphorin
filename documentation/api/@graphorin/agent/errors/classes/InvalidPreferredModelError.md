...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / InvalidPreferredModelError

# Class: InvalidPreferredModelError

Defined in: [packages/agent/src/errors/index.ts:74](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L74)
...
```ts
new InvalidPreferredModelError(value): InvalidPreferredModelError;
```

Defined in: [packages/agent/src/errors/index.ts:76](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L76)
...
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | [packages/agent/src/errors/index.ts:75](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L75) |
