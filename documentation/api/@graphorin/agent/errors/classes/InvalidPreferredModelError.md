...
Defined in: packages/agent/src/errors/index.ts:80
...
Defined in: packages/agent/src/errors/index.ts:82
...
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | packages/agent/src/errors/index.ts:81 |
