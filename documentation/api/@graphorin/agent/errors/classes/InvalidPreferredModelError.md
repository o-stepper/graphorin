...
Defined in: packages/agent/src/errors/index.ts:75
...
Defined in: packages/agent/src/errors/index.ts:77
...
| <a id="property-value"></a> `value` | `readonly` | `unknown` | - | - | packages/agent/src/errors/index.ts:76 |
