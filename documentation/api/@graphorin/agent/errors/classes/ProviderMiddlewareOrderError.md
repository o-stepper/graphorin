...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / ProviderMiddlewareOrderError

# Class: ProviderMiddlewareOrderError

Defined in: [packages/agent/src/errors/index.ts:345](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L345)
...
Defined in: [packages/agent/src/errors/index.ts:346](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L346)
