...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / RunStateMalformedError

# Class: RunStateMalformedError

Defined in: [packages/agent/src/errors/index.ts:228](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L228)
...
Defined in: [packages/agent/src/errors/index.ts:229](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L229)
