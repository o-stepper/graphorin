...
Defined in: packages/agent/src/errors/index.ts:219
...
Defined in: packages/agent/src/errors/index.ts:222
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-boundary"></a> `boundary` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:220 |
...
| <a id="property-matchedpattern"></a> `matchedPattern` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:221 |
