...
Defined in: [packages/agent/src/errors/index.ts:262](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L262)
...
Defined in: [packages/agent/src/errors/index.ts:265](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L265)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-boundary"></a> `boundary` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:263](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L263) |
...
| <a id="property-matchedpattern"></a> `matchedPattern` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:264](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L264) |
