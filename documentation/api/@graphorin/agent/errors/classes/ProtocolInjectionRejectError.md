...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / ProtocolInjectionRejectError

# Class: ProtocolInjectionRejectError

Defined in: [packages/agent/src/errors/index.ts:263](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L263)
...
Defined in: [packages/agent/src/errors/index.ts:266](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L266)
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-boundary"></a> `boundary` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:264](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L264) |
...
| <a id="property-matchedpattern"></a> `matchedPattern` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:265](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L265) |
