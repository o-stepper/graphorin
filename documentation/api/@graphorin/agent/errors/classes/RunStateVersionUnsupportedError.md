...
Defined in: packages/agent/src/errors/index.ts:187
...
| <a id="property-readerversion"></a> `readerVersion` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:186 |
...
| <a id="property-version"></a> `version` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:185 |
