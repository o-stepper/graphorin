...
Defined in: packages/agent/src/errors/index.ts:213
...
Defined in: packages/agent/src/errors/index.ts:216
...
| <a id="property-readerversion"></a> `readerVersion` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:215 |
...
| <a id="property-version"></a> `version` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:214 |
