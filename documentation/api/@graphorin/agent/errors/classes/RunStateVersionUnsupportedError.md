...
Defined in: packages/agent/src/errors/index.ts:163
...
Defined in: packages/agent/src/errors/index.ts:166
...
| <a id="property-readerversion"></a> `readerVersion` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:165 |
...
| <a id="property-version"></a> `version` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:164 |
