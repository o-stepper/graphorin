...
Defined in: packages/agent/src/errors/index.ts:209
...
| <a id="property-readerversion"></a> `readerVersion` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:208 |
...
| <a id="property-version"></a> `version` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:207 |
