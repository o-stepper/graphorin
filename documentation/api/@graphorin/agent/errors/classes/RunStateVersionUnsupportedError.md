...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / RunStateVersionUnsupportedError

# Class: RunStateVersionUnsupportedError

Defined in: [packages/agent/src/errors/index.ts:206](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L206)
...
```ts
new RunStateVersionUnsupportedError(version, readerVersion): RunStateVersionUnsupportedError;
```

Defined in: [packages/agent/src/errors/index.ts:209](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L209)
...
| <a id="property-readerversion"></a> `readerVersion` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:208](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L208) |
...
| <a id="property-version"></a> `version` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:207](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L207) |
