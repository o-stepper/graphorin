...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / AgentResolutionError

# Class: AgentResolutionError

Defined in: packages/agent/src/errors/index.ts:108
...
Defined in: packages/agent/src/errors/index.ts:110
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-agentid"></a> `agentId` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:109 |
