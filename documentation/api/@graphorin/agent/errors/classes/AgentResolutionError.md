...
Defined in: packages/agent/src/errors/index.ts:109
...
Defined in: packages/agent/src/errors/index.ts:111
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-agentid"></a> `agentId` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:110 |
