...
Defined in: [packages/agent/src/errors/index.ts:241](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L241)
...
Defined in: [packages/agent/src/errors/index.ts:244](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L244)
...
| <a id="property-fanoutid"></a> `fanOutId` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:242](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L242) |
...
| <a id="property-reason"></a> `reason` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:243](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L243) |
