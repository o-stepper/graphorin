...
Defined in: packages/agent/src/errors/index.ts:242
...
Defined in: packages/agent/src/errors/index.ts:245
...
| <a id="property-fanoutid"></a> `fanOutId` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:243 |
...
| <a id="property-reason"></a> `reason` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:244 |
