...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / MergeBlockedError

# Class: MergeBlockedError

Defined in: [packages/agent/src/errors/index.ts:240](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L240)
...
```ts
new MergeBlockedError(fanOutId, reason): MergeBlockedError;
```

Defined in: [packages/agent/src/errors/index.ts:243](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L243)
...
| <a id="property-fanoutid"></a> `fanOutId` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:241](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L241) |
...
| <a id="property-reason"></a> `reason` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:242](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L242) |
