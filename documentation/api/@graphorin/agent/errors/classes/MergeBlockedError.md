...
Defined in: packages/agent/src/errors/index.ts:218
...
Defined in: packages/agent/src/errors/index.ts:221
...
| <a id="property-fanoutid"></a> `fanOutId` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:219 |
...
| <a id="property-reason"></a> `reason` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:220 |
