...
Defined in: packages/agent/src/errors/index.ts:200
...
| <a id="property-fanoutid"></a> `fanOutId` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:198 |
...
| <a id="property-reason"></a> `reason` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:199 |
