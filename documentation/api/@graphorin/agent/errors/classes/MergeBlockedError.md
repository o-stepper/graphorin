...
Defined in: packages/agent/src/errors/index.ts:247
...
Defined in: packages/agent/src/errors/index.ts:250
...
| <a id="property-fanoutid"></a> `fanOutId` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:248 |
...
| <a id="property-reason"></a> `reason` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:249 |
