...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / ProgressWriteError

# Class: ProgressWriteError

Defined in: [packages/agent/src/errors/index.ts:284](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L284)
...
```ts
new ProgressWriteError(path, cause): ProgressWriteError;
```

Defined in: [packages/agent/src/errors/index.ts:286](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L286)
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:285](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L285) |
