...
Defined in: packages/agent/src/errors/index.ts:290
...
Defined in: packages/agent/src/errors/index.ts:292
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:291 |
