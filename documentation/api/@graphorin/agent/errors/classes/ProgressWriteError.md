...
Defined in: packages/agent/src/errors/index.ts:261
...
Defined in: packages/agent/src/errors/index.ts:263
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:262 |
