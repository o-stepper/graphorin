...
Defined in: packages/agent/src/errors/index.ts:285
...
Defined in: packages/agent/src/errors/index.ts:287
...
| <a id="property-path"></a> `path` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:286 |
