...
Defined in: packages/agent/src/errors/index.ts:135
...
Defined in: packages/agent/src/errors/index.ts:137
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:136 |
