...
Defined in: packages/agent/src/errors/index.ts:130
...
Defined in: packages/agent/src/errors/index.ts:132
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:131 |
