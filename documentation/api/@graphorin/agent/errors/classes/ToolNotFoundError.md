...
Defined in: packages/agent/src/errors/index.ts:127
...
Defined in: packages/agent/src/errors/index.ts:129
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:128 |
