...
Defined in: packages/agent/src/errors/index.ts:126
...
Defined in: packages/agent/src/errors/index.ts:128
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:127 |
