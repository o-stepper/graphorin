...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / ToolNotFoundError

# Class: ToolNotFoundError

Defined in: [packages/agent/src/errors/index.ts:129](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L129)
...
Defined in: [packages/agent/src/errors/index.ts:131](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L131)
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | [packages/agent/src/errors/index.ts:130](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L130) |
