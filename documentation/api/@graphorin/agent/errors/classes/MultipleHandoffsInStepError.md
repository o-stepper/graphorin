...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / MultipleHandoffsInStepError

# Class: MultipleHandoffsInStepError

Defined in: [packages/agent/src/errors/index.ts:168](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L168)
...
Defined in: [packages/agent/src/errors/index.ts:170](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L170)
...
| <a id="property-handoffnames"></a> `handoffNames` | `readonly` | readonly `string`[] | - | - | [packages/agent/src/errors/index.ts:169](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L169) |
