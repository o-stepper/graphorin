...
Defined in: [packages/agent/src/errors/index.ts:167](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L167)
...
Defined in: [packages/agent/src/errors/index.ts:169](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L169)
...
| <a id="property-handoffnames"></a> `handoffNames` | `readonly` | readonly `string`[] | - | - | [packages/agent/src/errors/index.ts:168](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L168) |
