...
Defined in: packages/agent/src/errors/index.ts:167
...
| <a id="property-handoffnames"></a> `handoffNames` | `readonly` | readonly `string`[] | - | - | packages/agent/src/errors/index.ts:168 |
