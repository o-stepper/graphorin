...
Defined in: packages/agent/src/errors/index.ts:190
...
Defined in: packages/agent/src/errors/index.ts:192
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | - | - | packages/agent/src/errors/index.ts:191 |
