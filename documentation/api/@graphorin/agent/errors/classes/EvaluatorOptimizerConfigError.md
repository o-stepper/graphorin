...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / EvaluatorOptimizerConfigError

# Class: EvaluatorOptimizerConfigError

Defined in: [packages/agent/src/errors/index.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L94)
...
Defined in: [packages/agent/src/errors/index.ts:95](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L95)
