...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [errors](/api/@graphorin/agent/errors/index.md) / InvalidAgentConfigError

# Class: InvalidAgentConfigError

Defined in: [packages/agent/src/errors/index.ts:57](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L57)
...
Defined in: [packages/agent/src/errors/index.ts:58](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/errors/index.ts#L58)
