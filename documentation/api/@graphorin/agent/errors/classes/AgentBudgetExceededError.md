...
Defined in: packages/agent/src/errors/index.ts:316
...
Defined in: packages/agent/src/errors/index.ts:323
...
| <a id="property-limit"></a> `limit` | `readonly` | `number` | The configured ceiling. | - | packages/agent/src/errors/index.ts:322 |
...
| <a id="property-observed"></a> `observed` | `readonly` | `number` | Observed cumulative value at the between-step check. | - | packages/agent/src/errors/index.ts:320 |
| <a id="property-resource"></a> `resource` | `readonly` | `"cost"` \| `"tokens"` | Which ceiling tripped. | - | packages/agent/src/errors/index.ts:318 |
