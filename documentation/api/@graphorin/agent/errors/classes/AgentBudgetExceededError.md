...
Defined in: packages/agent/src/errors/index.ts:321
...
Defined in: packages/agent/src/errors/index.ts:328
...
| <a id="property-limit"></a> `limit` | `readonly` | `number` | The configured ceiling. | - | packages/agent/src/errors/index.ts:327 |
...
| <a id="property-observed"></a> `observed` | `readonly` | `number` | Observed cumulative value at the between-step check. | - | packages/agent/src/errors/index.ts:325 |
| <a id="property-resource"></a> `resource` | `readonly` | `"cost"` \| `"tokens"` | Which ceiling tripped. | - | packages/agent/src/errors/index.ts:323 |
