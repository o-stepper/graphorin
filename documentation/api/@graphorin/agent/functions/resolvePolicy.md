...
Defined in: [packages/agent/src/lateral-leak/protocol-guard.ts:60](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/lateral-leak/protocol-guard.ts#L60)
