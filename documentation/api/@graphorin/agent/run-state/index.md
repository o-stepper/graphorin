...
| ------ | ------ |
| [SerializedPendingSubRun](/api/@graphorin/agent/run-state/interfaces/SerializedPendingSubRun.md) | Serialized twin of core's `PendingSubRun` (W-001): the parked child state travels as its own versioned [SerializedRunState](/api/@graphorin/agent/run-state/interfaces/SerializedRunState.md). |
