...
| <a id="property-status"></a> `status` | `readonly` | `"completed"` \| `"failed"` \| `"budget-exceeded"` \| `"cancelled"` | - | [packages/agent/src/fanout/index.ts:78](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/fanout/index.ts#L78) |
