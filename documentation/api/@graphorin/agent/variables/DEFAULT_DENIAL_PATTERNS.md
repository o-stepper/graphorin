...
[Graphorin API reference](/api/index.md) / [@graphorin/agent](/api/@graphorin/agent/index.md) / [](/api/@graphorin/agent/README.md) / DEFAULT\_DENIAL\_PATTERNS

# Variable: DEFAULT\_DENIAL\_PATTERNS
