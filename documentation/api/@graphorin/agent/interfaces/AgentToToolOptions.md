...
| <a id="property-forwardevents"></a> `forwardEvents?` | `readonly` | `SubagentForwardPolicy` | Which child events forward into the parent stream. | packages/agent/src/types.ts:725 |
