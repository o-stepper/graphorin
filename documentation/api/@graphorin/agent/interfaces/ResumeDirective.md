...
Defined in: [packages/agent/src/types.ts:453](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/types.ts#L453)
...
| ------ | ------ | ------ | ------ |
| <a id="property-approvals"></a> `approvals?` | `readonly` | readonly `ApprovalDecision`[] | [packages/agent/src/types.ts:454](https://github.com/o-stepper/graphorin/blob/main/packages/agent/src/types.ts#L454) |
