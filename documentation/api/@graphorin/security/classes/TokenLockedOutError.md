...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / TokenLockedOutError

# Class: TokenLockedOutError

Defined in: [packages/security/src/auth/errors.ts:101](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L101)
...
```ts
new TokenLockedOutError(
   source, 
   identifier, 
   retryAfterMs): TokenLockedOutError;
```

Defined in: [packages/security/src/auth/errors.ts:107](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L107)
...
| <a id="property-identifier"></a> `identifier` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/auth/errors.ts:104](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L104) |
| <a id="property-kind"></a> `kind` | `readonly` | `"token-locked-out"` | `'token-locked-out'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/auth/errors.ts:102](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L102) |
...
| <a id="property-retryafterms"></a> `retryAfterMs` | `readonly` | `number` | `undefined` | - | - | - | [packages/security/src/auth/errors.ts:105](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L105) |
| <a id="property-source"></a> `source` | `readonly` | `"token"` \| `"ip"` | `undefined` | - | - | - | [packages/security/src/auth/errors.ts:103](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L103) |
