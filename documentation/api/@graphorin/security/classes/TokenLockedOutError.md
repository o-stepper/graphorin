...
Defined in: packages/security/src/auth/errors.ts:101
...
Defined in: packages/security/src/auth/errors.ts:107
...
| <a id="property-retryafterms"></a> `retryAfterMs` | `readonly` | `number` | `undefined` | - | - | - | packages/security/src/auth/errors.ts:105 |
| <a id="property-source"></a> `source` | `readonly` | `"token"` \| `"ip"` | `undefined` | - | - | - | packages/security/src/auth/errors.ts:103 |
