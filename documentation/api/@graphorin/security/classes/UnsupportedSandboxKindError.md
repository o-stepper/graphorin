...
Defined in: packages/security/src/sandbox/errors.ts:26
...
Defined in: packages/security/src/sandbox/errors.ts:32
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-available"></a> `available` | `readonly` | readonly `string`[] | `undefined` | The kinds the dispatcher knows about. | - | - | packages/security/src/sandbox/errors.ts:31 |
...
| <a id="property-requested"></a> `requested` | `readonly` | `string` | `undefined` | The kind the dispatcher could not satisfy. | - | - | packages/security/src/sandbox/errors.ts:29 |
