...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / SecretRequiredError

# Class: SecretRequiredError

Defined in: [packages/security/src/secrets/errors.ts:144](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L144)
...
```ts
new SecretRequiredError(key): SecretRequiredError;
```

Defined in: [packages/security/src/secrets/errors.ts:149](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L149)
...
| <a id="property-key"></a> `key` | `readonly` | `string` | `undefined` | The secret key that was missing. Safe to log. | - | - | [packages/security/src/secrets/errors.ts:147](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L147) |
| <a id="property-kind"></a> `kind` | `readonly` | `"secret-required"` | `'secret-required'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/secrets/errors.ts:145](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L145) |
