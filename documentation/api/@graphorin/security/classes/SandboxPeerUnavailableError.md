...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / SandboxPeerUnavailableError

# Class: SandboxPeerUnavailableError

Defined in: [packages/security/src/sandbox/errors.ts:48](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L48)
...
```ts
new SandboxPeerUnavailableError(
   adapter, 
   peer, 
   installCommand, 
   options?): SandboxPeerUnavailableError;
```

Defined in: [packages/security/src/sandbox/errors.ts:56](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L56)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-adapter"></a> `adapter` | `readonly` | `string` | `undefined` | Adapter that requested the peer. | - | - | [packages/security/src/sandbox/errors.ts:51](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L51) |
...
| <a id="property-installcommand"></a> `installCommand` | `readonly` | `string` | `undefined` | Verbatim install command shown to operators. | - | - | [packages/security/src/sandbox/errors.ts:55](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L55) |
| <a id="property-kind"></a> `kind` | `readonly` | `"sandbox-peer-unavailable"` | `'sandbox-peer-unavailable'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSandboxError`](/api/@graphorin/security/classes/GraphorinSandboxError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSandboxError.md#property-kind) | - | [packages/security/src/sandbox/errors.ts:49](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L49) |
...
| <a id="property-peer"></a> `peer` | `readonly` | `string` | `undefined` | npm package name that was missing. | - | - | [packages/security/src/sandbox/errors.ts:53](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L53) |
