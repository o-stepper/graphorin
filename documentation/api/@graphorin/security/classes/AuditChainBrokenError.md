...
Defined in: packages/security/src/audit/errors.ts:44
...
Defined in: packages/security/src/audit/errors.ts:50
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actualhash"></a> `actualHash` | `readonly` | `string` | `undefined` | - | - | - | packages/security/src/audit/errors.ts:48 |
...
| <a id="property-expectedhash"></a> `expectedHash` | `readonly` | `string` | `undefined` | - | - | - | packages/security/src/audit/errors.ts:47 |
...
| <a id="property-seq"></a> `seq` | `readonly` | `number` | `undefined` | - | - | - | packages/security/src/audit/errors.ts:46 |
