...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / AuditChainBrokenError

# Class: AuditChainBrokenError

Defined in: [packages/security/src/audit/errors.ts:44](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L44)
...
```ts
new AuditChainBrokenError(
   seq, 
   expectedHash, 
   actualHash): AuditChainBrokenError;
```

Defined in: [packages/security/src/audit/errors.ts:50](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L50)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-actualhash"></a> `actualHash` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/audit/errors.ts:48](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L48) |
...
| <a id="property-expectedhash"></a> `expectedHash` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/audit/errors.ts:47](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L47) |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"audit-chain-broken"` | `'audit-chain-broken'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/audit/errors.ts:45](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L45) |
...
| <a id="property-seq"></a> `seq` | `readonly` | `number` | `undefined` | - | - | - | [packages/security/src/audit/errors.ts:46](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L46) |
