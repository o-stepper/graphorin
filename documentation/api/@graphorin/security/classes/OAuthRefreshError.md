...
Defined in: [packages/security/src/oauth/errors.ts:134](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L134)
...
Defined in: [packages/security/src/oauth/errors.ts:137](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L137)
...
| <a id="property-providererror"></a> `providerError?` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:136](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L136) |
| <a id="property-serverid"></a> `serverId` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:135](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L135) |
