...
Defined in: [packages/security/src/oauth/errors.ts:69](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L69)
...
Defined in: [packages/security/src/oauth/errors.ts:72](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L72)
...
| <a id="property-providererror"></a> `providerError?` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:71](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L71) |
| <a id="property-serverid"></a> `serverId` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:70](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L70) |
