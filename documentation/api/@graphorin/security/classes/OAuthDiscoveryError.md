...
Defined in: [packages/security/src/oauth/errors.ts:33](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L33)
...
Defined in: [packages/security/src/oauth/errors.ts:35](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L35)
...
| <a id="property-serverurl"></a> `serverUrl` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:34](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L34) |
