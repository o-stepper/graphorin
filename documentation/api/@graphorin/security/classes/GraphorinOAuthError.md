...
Defined in: packages/security/src/oauth/errors.ts:15
...
Defined in: packages/security/src/oauth/errors.ts:19
...
| <a id="property-hint"></a> `hint?` | `readonly` | `string` | - | - | packages/security/src/oauth/errors.ts:17 |
| <a id="property-kind"></a> `kind` | `readonly` | `string` | - | - | packages/security/src/oauth/errors.ts:16 |
