...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / GraphorinOAuthError

# Class: GraphorinOAuthError

Defined in: [packages/security/src/oauth/errors.ts:15](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L15)
...
- [`OAuthAuthorizationError`](/api/@graphorin/security/classes/OAuthAuthorizationError.md)
- [`OAuthCallbackError`](/api/@graphorin/security/classes/OAuthCallbackError.md)
- [`OAuthCallbackPortError`](/api/@graphorin/security/classes/OAuthCallbackPortError.md)
- [`OAuthDiscoveryError`](/api/@graphorin/security/classes/OAuthDiscoveryError.md)
...
```ts
new GraphorinOAuthError(
   kind, 
   message, 
   options?): GraphorinOAuthError;
```

Defined in: [packages/security/src/oauth/errors.ts:19](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L19)
...
| <a id="property-hint"></a> `hint?` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:17](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L17) |
| <a id="property-kind"></a> `kind` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:16](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L16) |
