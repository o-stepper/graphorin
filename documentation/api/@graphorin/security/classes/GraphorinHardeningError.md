...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / GraphorinHardeningError

# Abstract Class: GraphorinHardeningError

Defined in: [packages/security/src/hardening/errors.ts:16](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/hardening/errors.ts#L16)
...
- [`FileModeMismatchError`](/api/@graphorin/security/classes/FileModeMismatchError.md)
- [`RefuseToRunAsRootError`](/api/@graphorin/security/classes/RefuseToRunAsRootError.md)
...
```ts
new GraphorinHardeningError(
   kind, 
   message, 
   options?): GraphorinHardeningError;
```
