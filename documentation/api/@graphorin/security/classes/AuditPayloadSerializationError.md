...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / AuditPayloadSerializationError

# Class: AuditPayloadSerializationError

Defined in: packages/security/src/audit/errors.ts:71
...
```ts
new AuditPayloadSerializationError(reason): AuditPayloadSerializationError;
```

Defined in: packages/security/src/audit/errors.ts:74
...
| <a id="property-kind"></a> `kind` | `readonly` | `"audit-payload-serialization"` | `'audit-payload-serialization'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | packages/security/src/audit/errors.ts:72 |
