...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / ScopeParseError

# Class: ScopeParseError

Defined in: [packages/security/src/auth/errors.ts:54](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L54)
...
```ts
new ScopeParseError(input, reason): ScopeParseError;
```

Defined in: [packages/security/src/auth/errors.ts:59](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L59)
...
| <a id="property-input"></a> `input` | `readonly` | `string` | `undefined` | Original input string. Safe to log - never carries a secret. | - | - | [packages/security/src/auth/errors.ts:57](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L57) |
| <a id="property-kind"></a> `kind` | `readonly` | `"scope-parse-error"` | `'scope-parse-error'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/auth/errors.ts:55](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L55) |
