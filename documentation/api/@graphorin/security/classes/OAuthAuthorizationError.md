...
Defined in: [packages/security/src/oauth/errors.ts:189](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L189)
...
Defined in: [packages/security/src/oauth/errors.ts:192](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L192)
...
| <a id="property-oautherror"></a> `oauthError` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:190](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L190) |
| <a id="property-oautherrordescription"></a> `oauthErrorDescription?` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:191](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L191) |
