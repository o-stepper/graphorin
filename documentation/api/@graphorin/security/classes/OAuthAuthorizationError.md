...
Defined in: [packages/security/src/oauth/errors.ts:124](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L124)
...
Defined in: [packages/security/src/oauth/errors.ts:127](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L127)
...
| <a id="property-oautherror"></a> `oauthError` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:125](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L125) |
| <a id="property-oautherrordescription"></a> `oauthErrorDescription?` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:126](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L126) |
