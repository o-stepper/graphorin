...
Defined in: packages/security/src/secrets/errors.ts:104
...
Defined in: packages/security/src/secrets/errors.ts:111
...
| <a id="property-ref"></a> `ref` | `readonly` | `string` | `undefined` | Original ref input — safe to log. | - | - | packages/security/src/secrets/errors.ts:109 |
| <a id="property-scheme"></a> `scheme` | `readonly` | `string` | `undefined` | Lowercased scheme that ran. | - | - | packages/security/src/secrets/errors.ts:107 |
