...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / SecretResolutionError

# Class: SecretResolutionError

Defined in: [packages/security/src/secrets/errors.ts:104](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L104)
...
new SecretResolutionError(
   ...
   ref, 
   reason, 
   options?): SecretResolutionError;
```

Defined in: [packages/security/src/secrets/errors.ts:111](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L111)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"resolution-failed"` | `'resolution-failed'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/secrets/errors.ts:105](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L105) |
...
| <a id="property-ref"></a> `ref` | `readonly` | `string` | `undefined` | Original ref input - safe to log. | - | - | [packages/security/src/secrets/errors.ts:109](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L109) |
| <a id="property-scheme"></a> `scheme` | `readonly` | `string` | `undefined` | Lowercased scheme that ran. | - | - | [packages/security/src/secrets/errors.ts:107](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L107) |
