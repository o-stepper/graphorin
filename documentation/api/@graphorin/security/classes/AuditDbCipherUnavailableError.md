...
Defined in: packages/security/src/audit/errors.ts:16
...
Defined in: packages/security/src/audit/errors.ts:24
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-binding"></a> `binding` | `readonly` | `string` | `undefined` | Identifier of the binding that was requested. | - | - | packages/security/src/audit/errors.ts:19 |
