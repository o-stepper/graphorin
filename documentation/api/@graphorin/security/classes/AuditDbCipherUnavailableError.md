...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / AuditDbCipherUnavailableError

# Class: AuditDbCipherUnavailableError

Defined in: [packages/security/src/audit/errors.ts:16](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L16)
...
```ts
new AuditDbCipherUnavailableError(binding, message?): AuditDbCipherUnavailableError;
```

Defined in: [packages/security/src/audit/errors.ts:24](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L24)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-binding"></a> `binding` | `readonly` | `string` | `undefined` | Identifier of the binding that was requested. | - | - | [packages/security/src/audit/errors.ts:19](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L19) |
...
| <a id="property-installcommand"></a> `installCommand` | `readonly` | `string` | `'pnpm add @graphorin/store-sqlite better-sqlite3-multiple-ciphers'` | Verbatim install command that resolves the missing binding. | - | - | [packages/security/src/audit/errors.ts:21](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L21) |
| <a id="property-kind"></a> `kind` | `readonly` | `"audit-db-cipher-unavailable"` | `'audit-db-cipher-unavailable'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/audit/errors.ts:17](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/audit/errors.ts#L17) |
