...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / StrictSecretsUnavailableError

# Class: StrictSecretsUnavailableError

Defined in: [packages/security/src/secrets/errors.ts:212](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L212)
...
```ts
new StrictSecretsUnavailableError(source, reasons): StrictSecretsUnavailableError;
```

Defined in: [packages/security/src/secrets/errors.ts:219](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L219)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"strict-secrets-unavailable"` | `'strict-secrets-unavailable'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/secrets/errors.ts:213](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L213) |
...
| <a id="property-reasons"></a> `reasons` | `readonly` | readonly `string`[] | `undefined` | Reasons the store could not be activated. | - | - | [packages/security/src/secrets/errors.ts:217](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L217) |
| <a id="property-source"></a> `source` | `readonly` | `string` | `undefined` | Identifier of the source that was requested. | - | - | [packages/security/src/secrets/errors.ts:215](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L215) |
