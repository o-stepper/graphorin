...
Defined in: packages/security/src/secrets/errors.ts:212
...
Defined in: packages/security/src/secrets/errors.ts:219
...
| <a id="property-reasons"></a> `reasons` | `readonly` | readonly `string`[] | `undefined` | Reasons the store could not be activated. | - | - | packages/security/src/secrets/errors.ts:217 |
| <a id="property-source"></a> `source` | `readonly` | `string` | `undefined` | Identifier of the source that was requested. | - | - | packages/security/src/secrets/errors.ts:215 |
