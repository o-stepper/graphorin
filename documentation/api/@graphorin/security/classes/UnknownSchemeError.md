...
Defined in: packages/security/src/secrets/errors.ts:82
...
Defined in: packages/security/src/secrets/errors.ts:89
...
| <a id="property-ref"></a> `ref` | `readonly` | `string` | `undefined` | Original ref input - safe to log. | - | - | packages/security/src/secrets/errors.ts:87 |
| <a id="property-scheme"></a> `scheme` | `readonly` | `string` | `undefined` | Lowercased scheme that failed lookup. | - | - | packages/security/src/secrets/errors.ts:85 |
