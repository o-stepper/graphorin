...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / UnknownSchemeError

# Class: UnknownSchemeError

Defined in: [packages/security/src/secrets/errors.ts:82](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L82)
...
```ts
new UnknownSchemeError(scheme, ref): UnknownSchemeError;
```

Defined in: [packages/security/src/secrets/errors.ts:89](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L89)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"unknown-scheme"` | `'unknown-scheme'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/secrets/errors.ts:83](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L83) |
...
| <a id="property-ref"></a> `ref` | `readonly` | `string` | `undefined` | Original ref input - safe to log. | - | - | [packages/security/src/secrets/errors.ts:87](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L87) |
| <a id="property-scheme"></a> `scheme` | `readonly` | `string` | `undefined` | Lowercased scheme that failed lookup. | - | - | [packages/security/src/secrets/errors.ts:85](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L85) |
