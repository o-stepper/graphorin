...
Defined in: packages/security/src/auth/errors.ts:76
...
Defined in: packages/security/src/auth/errors.ts:81
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-cap"></a> `cap` | `readonly` | `number` | `undefined` | - | - | - | packages/security/src/auth/errors.ts:79 |
