...
Defined in: packages/security/src/auth/errors.ts:130
...
```ts
new WeakPepperError(providedBytes): WeakPepperError;
```

Defined in: packages/security/src/auth/errors.ts:134
...
| <a id="property-providedbytes"></a> `providedBytes` | `readonly` | `number` | `undefined` | - | - | - | packages/security/src/auth/errors.ts:132 |
