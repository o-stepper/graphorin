...
Defined in: packages/security/src/auth/errors.ts:136
...
| <a id="property-providedbytes"></a> `providedBytes` | `readonly` | `number` | `undefined` | - | - | - | packages/security/src/auth/errors.ts:134 |
