...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / WeakPepperError

# Class: WeakPepperError

Defined in: [packages/security/src/auth/errors.ts:132](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L132)
...
```ts
new WeakPepperError(providedBytes, reason?): WeakPepperError;
```

Defined in: [packages/security/src/auth/errors.ts:136](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L136)
...
| <a id="property-kind"></a> `kind` | `readonly` | `"weak-pepper"` | `'weak-pepper'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/auth/errors.ts:133](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L133) |
...
| <a id="property-providedbytes"></a> `providedBytes` | `readonly` | `number` | `undefined` | - | - | - | [packages/security/src/auth/errors.ts:134](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L134) |
