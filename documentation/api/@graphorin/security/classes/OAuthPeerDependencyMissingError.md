...
Defined in: [packages/security/src/oauth/errors.ts:238](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L238)
...
Defined in: [packages/security/src/oauth/errors.ts:240](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L240)
...
| <a id="property-packagename"></a> `packageName` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:239](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L239) |
