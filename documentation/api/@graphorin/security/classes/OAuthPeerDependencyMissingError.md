...
Defined in: [packages/security/src/oauth/errors.ts:173](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L173)
...
Defined in: [packages/security/src/oauth/errors.ts:175](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L175)
...
| <a id="property-packagename"></a> `packageName` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:174](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L174) |
