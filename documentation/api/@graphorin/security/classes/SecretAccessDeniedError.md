...
Defined in: [packages/security/src/secrets/errors.ts:163](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L163)
...
Defined in: [packages/security/src/secrets/errors.ts:172](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L172)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-allowedset"></a> `allowedSet` | `readonly` | readonly `string`[] | `undefined` | Snapshot of the currently-effective allowlist. | - | - | [packages/security/src/secrets/errors.ts:170](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L170) |
...
| <a id="property-key"></a> `key` | `readonly` | `string` | `undefined` | The denied secret key. | - | - | [packages/security/src/secrets/errors.ts:166](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L166) |
| <a id="property-kind"></a> `kind` | `readonly` | `"secret-access-denied"` | `'secret-access-denied'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/secrets/errors.ts:164](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L164) |
...
| <a id="property-toolname"></a> `toolName` | `readonly` | `string` | `undefined` | Tool that issued the request. | - | - | [packages/security/src/secrets/errors.ts:168](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/secrets/errors.ts#L168) |
