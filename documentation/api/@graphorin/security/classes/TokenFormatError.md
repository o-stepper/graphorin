...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / TokenFormatError

# Class: TokenFormatError

Defined in: [packages/security/src/auth/errors.ts:33](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L33)
...
new TokenFormatError(
   kind, 
   message, 
   inputLength): TokenFormatError;
```

Defined in: [packages/security/src/auth/errors.ts:38](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L38)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `kind` | [`TokenFormatErrorKind`](/api/@graphorin/security/type-aliases/TokenFormatErrorKind.md) |
| `message` | `string` |
| `inputLength` | `number` |
...
| <a id="property-inputlength"></a> `inputLength` | `readonly` | `number` | Length of the rejected input. The raw value is never logged. | - | - | [packages/security/src/auth/errors.ts:36](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L36) |
| <a id="property-kind"></a> `kind` | `readonly` | [`TokenFormatErrorKind`](/api/@graphorin/security/type-aliases/TokenFormatErrorKind.md) | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | [packages/security/src/auth/errors.ts:34](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/auth/errors.ts#L34) |
