...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / LiteralSecretsForbiddenError

# Class: LiteralSecretsForbiddenError

Defined in: packages/security/src/secrets/errors.ts:128
...
```ts
new LiteralSecretsForbiddenError(reason): LiteralSecretsForbiddenError;
```

Defined in: packages/security/src/secrets/errors.ts:131
...
| <a id="property-kind"></a> `kind` | `readonly` | `"literal-secrets-forbidden"` | `'literal-secrets-forbidden'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSecretsError`](/api/@graphorin/security/classes/GraphorinSecretsError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSecretsError.md#property-kind) | - | packages/security/src/secrets/errors.ts:129 |
