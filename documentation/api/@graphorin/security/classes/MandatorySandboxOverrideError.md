...
[Graphorin API reference](/api/index.md) / [@graphorin/security](/api/@graphorin/security/index.md) / [](/api/@graphorin/security/README.md) / MandatorySandboxOverrideError

# Class: MandatorySandboxOverrideError

Defined in: [packages/security/src/sandbox/errors.ts:81](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L81)
...
```ts
new MandatorySandboxOverrideError(
   tier, 
   attempted, 
   mandated): MandatorySandboxOverrideError;
```

Defined in: [packages/security/src/sandbox/errors.ts:86](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L86)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-attempted"></a> `attempted` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/sandbox/errors.ts:84](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L84) |
...
| <a id="property-kind"></a> `kind` | `readonly` | `"mandatory-sandbox-override"` | `'mandatory-sandbox-override'` | Stable lowercase discriminator. Subclasses fix this to a literal. | [`GraphorinSandboxError`](/api/@graphorin/security/classes/GraphorinSandboxError.md).[`kind`](/api/@graphorin/security/classes/GraphorinSandboxError.md#property-kind) | - | [packages/security/src/sandbox/errors.ts:82](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L82) |
| <a id="property-mandated"></a> `mandated` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/sandbox/errors.ts:85](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L85) |
...
| <a id="property-tier"></a> `tier` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/sandbox/errors.ts:83](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L83) |
