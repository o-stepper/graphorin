...
Defined in: [packages/security/src/sandbox/errors.ts:104](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L104)
...
Defined in: [packages/security/src/sandbox/errors.ts:107](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L107)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-attemptedpath"></a> `attemptedPath?` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/sandbox/errors.ts:106](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L106) |
