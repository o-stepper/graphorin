...
Defined in: packages/security/src/secrets/errors.ts:238
...
Defined in: packages/security/src/secrets/errors.ts:243
...
| <a id="property-packagename"></a> `packageName` | `readonly` | `string` | `undefined` | npm package name that was missing. | - | - | packages/security/src/secrets/errors.ts:241 |
