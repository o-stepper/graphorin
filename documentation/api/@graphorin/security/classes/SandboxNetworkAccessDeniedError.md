...
Defined in: [packages/security/src/sandbox/errors.ts:125](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L125)
...
Defined in: [packages/security/src/sandbox/errors.ts:128](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L128)
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="property-attemptedhost"></a> `attemptedHost?` | `readonly` | `string` | `undefined` | - | - | - | [packages/security/src/sandbox/errors.ts:127](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/sandbox/errors.ts#L127) |
