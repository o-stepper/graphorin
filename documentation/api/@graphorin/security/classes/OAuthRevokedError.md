...
Defined in: [packages/security/src/oauth/errors.ts:161](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L161)
...
| <a id="property-serverid"></a> `serverId` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:160](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L160) |
