...
Defined in: [packages/security/src/oauth/errors.ts:94](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L94)
...
Defined in: [packages/security/src/oauth/errors.ts:96](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L96)
...
| <a id="property-serverid"></a> `serverId` | `readonly` | `string` | - | - | [packages/security/src/oauth/errors.ts:95](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/oauth/errors.ts#L95) |
