...
Defined in: [packages/security/src/supply-chain/types.ts:24](https://github.com/o-stepper/graphorin/blob/main/packages/security/src/supply-chain/types.ts#L24)
