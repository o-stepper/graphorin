...
| <a id="property-mode"></a> `mode` | `readonly` | [`DataFlowMode`](/api/@graphorin/security/type-aliases/DataFlowMode.md) | Enforcement mode. See [DataFlowMode](/api/@graphorin/security/type-aliases/DataFlowMode.md). | packages/security/src/dataflow/types.ts:184 |
