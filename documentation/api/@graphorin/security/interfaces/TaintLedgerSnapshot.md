...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-sensitiveseen"></a> `sensitiveSeen` | `readonly` | `boolean` | - | packages/security/src/dataflow/types.ts:162 |
...
| <a id="property-untrustedseen"></a> `untrustedSeen` | `readonly` | `boolean` | - | packages/security/src/dataflow/types.ts:161 |
| <a id="property-untrustedsourcekinds"></a> `untrustedSourceKinds` | `readonly` | readonly `string`[] | - | packages/security/src/dataflow/types.ts:163 |
