...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-carriesuntrustedverbatim"></a> `carriesUntrustedVerbatim` | `readonly` | `boolean` | `true` when the serialized arguments share a substantial verbatim span with previously-recorded untrusted output (best-effort: catches verbatim / near-verbatim forwarding, not paraphrase). | packages/security/src/dataflow/types.ts:97 |
| <a id="property-matchedsourcekinds"></a> `matchedSourceKinds` | `readonly` | readonly `string`[] | Untrusted source kinds whose recorded output matched the arguments. | packages/security/src/dataflow/types.ts:99 |
