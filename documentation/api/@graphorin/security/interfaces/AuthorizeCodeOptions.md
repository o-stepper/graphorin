...
| <a id="property-signal"></a> `signal?` | `readonly` | `AbortSignal` | Cancellation. Aborts the callback server, browser open, and exchange. | packages/security/src/oauth/types.ts:208 |
