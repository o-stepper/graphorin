...
Defined in: [packages/triggers/src/cron.ts:40](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L40)
...
Defined in: [packages/triggers/src/cron.ts:42](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L42)
...
| <a id="property-expression"></a> `expression` | `readonly` | `string` | `undefined` | - | - | - | [packages/triggers/src/cron.ts:43](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L43) |
...
| <a id="property-name"></a> `name` | `readonly` | `"CronParseError"` | `'CronParseError'` | - | `Error.name` | - | [packages/triggers/src/cron.ts:41](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L41) |
