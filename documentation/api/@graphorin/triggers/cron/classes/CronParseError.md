...
Defined in: [packages/triggers/src/cron.ts:53](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L53)
...
| <a id="property-expression"></a> `expression` | `readonly` | `string` | `undefined` | - | - | - | [packages/triggers/src/cron.ts:54](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L54) |
...
| <a id="property-name"></a> `name` | `readonly` | `"CronParseError"` | `'CronParseError'` | - | `Error.name` | - | [packages/triggers/src/cron.ts:52](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/cron.ts#L52) |
