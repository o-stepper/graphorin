...
Defined in: [packages/triggers/src/index.ts:53](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/index.ts#L53)
...
Defined in: [packages/triggers/src/index.ts:55](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/index.ts#L55)
...
| <a id="property-limit"></a> `limit` | `readonly` | `"interval-floor"` \| `"max-declarations"` | `undefined` | - | - | - | [packages/triggers/src/index.ts:57](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/index.ts#L57) |
...
| <a id="property-name"></a> `name` | `readonly` | `"TriggerLimitError"` | `'TriggerLimitError'` | - | `Error.name` | - | [packages/triggers/src/index.ts:54](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/index.ts#L54) |
...
| <a id="property-triggerid"></a> `triggerId` | `readonly` | `string` | `undefined` | - | - | - | [packages/triggers/src/index.ts:56](https://github.com/o-stepper/graphorin/blob/main/packages/triggers/src/index.ts#L56) |
