...
description: "Runtime, peer, and build-time dependencies pulled in by Graphorin, with versions, licenses, and the role each plays."
editLink: false
---

<!--
  This page is auto-synced from /THIRD_PARTY_NOTICES.md on every documentation build.
  Do not edit it directly — change /THIRD_PARTY_NOTICES.md in the repository root.
-->
...
dependency surface as of the v0.2.0 release.
...
|---|---|---|---|
| [`ai`](https://github.com/vercel/ai) (Vercel AI SDK v7 beta) | `^7.0.0-beta.76` | Apache-2.0 | Wrapped by `vercelAdapter` in `@graphorin/provider`; default cloud-LLM driver. |
...
| Component | Pin | License | Role inside Graphorin |
|---|---|---|---|
| [`hono`](https://github.com/honojs/hono) | `^4.12.0` | MIT | HTTP router for `@graphorin/server` REST + SSE + WebSocket routes. |
...
| [`@opentelemetry/sdk-node`](https://github.com/open-telemetry/opentelemetry-js) | `^0.215.0` | Apache-2.0 | Node.js OpenTelemetry SDK plumbing for the optional OTLP exporter. |
...
| [`turbo`](https://github.com/vercel/turborepo) | `^2.5.0` | MPL-2.0 | Monorepo task runner used by `pnpm build` / `pnpm test` / `pnpm typecheck` (build-time only; not redistributed). |
| [`vitest`](https://github.com/vitest-dev/vitest) | `^3.0.0` | MIT | Test runner across every workspace package. |
...
[`CODE_OF_CONDUCT.md`](/contributing/code-of-conduct) reproduces the unmodified
...
**Project Graphorin** · v0.2.0 · MIT License · © 2026 Oleksiy Stepurenko · <https://graphorin.com> · <https://github.com/o-stepper/graphorin>
