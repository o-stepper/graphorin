...
description: "Vulnerability disclosure process, supported versions, and the project's privacy and cryptographic baselines."
editLink: false
---
...
| Version | Supported |
|---------|-----------|
| 0.11.x   | Yes (current pre-release line) |
