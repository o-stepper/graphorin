...
```
graphorin v0.13.6 local-stack-cli - recipe='ollama', model='qwen2.5:7b-instruct-q4_K_M'. Type a message and press Enter; Ctrl+C to exit.
> hello
...
graphorin v0.13.6 local-stack-cli - recipe='ollama', model='qwen2.5:7b-instruct-q4_K_M'. ...
