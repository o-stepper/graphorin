...
```
graphorin v0.10.2 three-agent-harness - recipe='stub', runId='harness_..._...', termination='pass', iterations=1, finalScore=9.
```
...
```
graphorin v0.10.2 three-agent-harness research-and-decide - children=3, bound=3, unbound=0.
```
