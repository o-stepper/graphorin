...
```
graphorin v0.13.6 personal-assistant-cli - recipe='stub', model='stub-echo'. Type a message and press Enter; Ctrl+C to exit.
> hello there
...
```
graphorin v0.13.6 personal-assistant-cli - recipe='ollama', model='qwen2.5:7b-instruct-q4_K_M'. Type a message and press Enter; Ctrl+C to exit.
...
```
graphorin v0.13.6 personal-assistant-cli - recipe='llamacpp-server', model='llama'. ...
```
