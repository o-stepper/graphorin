...
```
graphorin v0.5.0 approval-workflow auto — status=completed, approved=true, notifications=4.
graphorin v0.5.0 approval-workflow manual — status=suspended, suspendedAtNode='auto-approve-or-pause'.
graphorin v0.5.0 approval-workflow resume — status=completed, approved=true, processedAt='2026-…', notifications=4.
```
