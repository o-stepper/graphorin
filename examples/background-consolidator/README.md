...
```
graphorin v0.13.11 background-consolidator - recipe='stub', tier='cheap', running=true, turnsDriven=4, lightPhases=2, standardPhases=1, schedulerFires=1, triggers=[background-consolidator:idle-probe, background-consolidator:light-tick, consolidator:cron:0 3 * * *, consolidator:idle:10s].
```
