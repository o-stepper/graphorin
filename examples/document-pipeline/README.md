...
```
graphorin v0.2.0 document-pipeline — status=completed, pages=4, chunks=8, embeddings=8, summaries=4, parserNotice='metadata-collector observed 4 page(s)', indexedAt='2026-…'.
```
