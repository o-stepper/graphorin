...
```
graphorin v0.12.0 multi-agent-crew - recipe='stub', handoffs=2, messages=4, agents=3, output='Crew synthesis - researcher said: "[researched] Key findings about 'Summarise the design consid…'.
```
